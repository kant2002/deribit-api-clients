...
/**
 * The PublicTrade model module.
 * @module model/PublicTrade
 * @version 2.0.0
 */
class PublicTrade {
    /**
     * Constructs a new <code>PublicTrade</code>.
     * @alias module:model/PublicTrade
     * @param direction {module:model/PublicTrade.DirectionEnum} Trade direction of the taker
     * @param tickDirection {module:model/PublicTrade.TickDirectionEnum} Direction of the \"tick\" (`0` = Plus Tick, `1` = Zero-Plus Tick, `2` = Minus Tick, `3` = Zero-Minus Tick).
     ...
     */
    constructor(direction, tickDirection, timestamp, price, tradeSeq, tradeId, indexPrice, amount, instrumentName) { 
        
        PublicTrade.initialize(this, direction, tickDirection, timestamp, price, tradeSeq, tradeId, indexPrice, amount, instrumentName);
    }
     ...
     */
    static initialize(obj, direction, tickDirection, timestamp, price, tradeSeq, tradeId, indexPrice, amount, instrumentName) { 
    ...
    /**
     * Constructs a <code>PublicTrade</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublicTrade} obj Optional instance to populate.
     * @return {module:model/PublicTrade} The populated <code>PublicTrade</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicTrade();
 ...
 * @member {module:model/PublicTrade.DirectionEnum} direction
 */
PublicTrade.prototype['direction'] = undefined;

/**
 * Direction of the \"tick\" (`0` = Plus Tick, `1` = Zero-Plus Tick, `2` = Minus Tick, `3` = Zero-Minus Tick).
 * @member {module:model/PublicTrade.TickDirectionEnum} tick_direction
 */
PublicTrade.prototype['tick_direction'] = undefined;

/**
 * The timestamp of the trade
 * @member {Number} timestamp
 */
PublicTrade.prototype['timestamp'] = undefined;

/**
 * The price of the trade
 * @member {Number} price
 */
PublicTrade.prototype['price'] = undefined;

/**
 * The sequence number of the trade within instrument
 * @member {Number} trade_seq
 */
PublicTrade.prototype['trade_seq'] = undefined;

/**
 * Unique (per currency) trade identifier
 * @member {String} trade_id
 */
PublicTrade.prototype['trade_id'] = undefined;

/**
 * Option implied volatility for the price (Option only)
 * @member {Number} iv
 */
PublicTrade.prototype['iv'] = undefined;

/**
 * Index Price at the moment of trade
 * @member {Number} index_price
 */
PublicTrade.prototype['index_price'] = undefined;
 ...
 */
PublicTrade.prototype['amount'] = undefined;

/**
 * Unique instrument identifier
 * @member {String} instrument_name
 */
PublicTrade.prototype['instrument_name'] = undefined;
