...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeribitApi.InternalApi();
  });
  ...
  describe('InternalApi', function() {
    ...
    describe('publicGetFooterGet', function() {
      it('should call publicGetFooterGet successfully', function(done) {
        //uncomment below and update the code to test publicGetFooterGet
        //instance.publicGetFooterGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('publicGetOptionMarkPricesGet', function() {
      it('should call publicGetOptionMarkPricesGet successfully', function(done) {
        //uncomment below and update the code to test publicGetOptionMarkPricesGet
        //instance.publicGetOptionMarkPricesGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
