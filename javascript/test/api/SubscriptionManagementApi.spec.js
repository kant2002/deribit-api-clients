...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeribitApi.SubscriptionManagementApi();
  });
  ...
  describe('SubscriptionManagementApi', function() {
    ...
    describe('publicUnsubscribeGet', function() {
      it('should call publicUnsubscribeGet successfully', function(done) {
        //uncomment below and update the code to test publicUnsubscribeGet
        //instance.publicUnsubscribeGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
