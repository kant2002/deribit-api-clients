...
(function(root, factory) {
  ...
  describe('Order', function() {
    it('should create an instance of Order', function() {
      ...
      //var instane = new DeribitApi.Order();
      //expect(instance).to.be.a(DeribitApi.Order);
    });
    ...
    it('should have the property orderState (base name: "order_state")', function() {
      // uncomment below and update the code to test the property orderState
      //var instane = new DeribitApi.Order();
      //expect(instance).to.be();
    });

    it('should have the property implv (base name: "implv")', function() {
      // uncomment below and update the code to test the property implv
      //var instane = new DeribitApi.Order();
      //expect(instance).to.be();
    });
    ...
    it('should have the property postOnly (base name: "post_only")', function() {
      // uncomment below and update the code to test the property postOnly
      //var instane = new DeribitApi.Order();
      //expect(instance).to.be();
    });
    ...
    it('should have the property originalOrderType (base name: "original_order_type")', function() {
      // uncomment below and update the code to test the property originalOrderType
      //var instane = new DeribitApi.Order();
      //expect(instance).to.be();
    });

    it('should have the property maxShow (base name: "max_show")', function() {
      // uncomment below and update the code to test the property maxShow
      //var instane = new DeribitApi.Order();
      //expect(instance).to.be();
    });
    ...
    it('should have the property isLiquidation (base name: "is_liquidation")', function() {
      // uncomment below and update the code to test the property isLiquidation
      //var instane = new DeribitApi.Order();
      //expect(instance).to.be();
    });

    it('should have the property filledAmount (base name: "filled_amount")', function() {
      // uncomment below and update the code to test the property filledAmount
      //var instane = new DeribitApi.Order();
      //expect(instance).to.be();
    });
