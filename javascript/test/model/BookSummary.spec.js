...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeribitApi.BookSummary();
  });
  ...
  describe('BookSummary', function() {
    it('should create an instance of BookSummary', function() {
      // uncomment below and update the code to test BookSummary
      //var instane = new DeribitApi.BookSummary();
      //expect(instance).to.be.a(DeribitApi.BookSummary);
    });

    it('should have the property underlyingIndex (base name: "underlying_index")', function() {
      // uncomment below and update the code to test the property underlyingIndex
      //var instane = new DeribitApi.BookSummary();
    ...
    it('should have the property estimatedDeliveryPrice (base name: "estimated_delivery_price")', function() {
      // uncomment below and update the code to test the property estimatedDeliveryPrice
      //var instane = new DeribitApi.BookSummary();
      //expect(instance).to.be();
    });
    ...
    it('should have the property funding8h (base name: "funding_8h")', function() {
      // uncomment below and update the code to test the property funding8h
      //var instane = new DeribitApi.BookSummary();
      //expect(instance).to.be();
    });
    ...
    it('should have the property currentFunding (base name: "current_funding")', function() {
      // uncomment below and update the code to test the property currentFunding
      //var instane = new DeribitApi.BookSummary();
      //expect(instance).to.be();
    });
