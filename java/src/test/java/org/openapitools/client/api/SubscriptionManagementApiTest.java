...
/**
 * API tests for SubscriptionManagementApi
 */
@Ignore
public class SubscriptionManagementApiTest {

    private final SubscriptionManagementApi api = new SubscriptionManagementApi();
     ...
     */
    @Test
    public void publicUnsubscribeGetTest() throws ApiException {
        List<String> channels = null;
        Object response = api.publicUnsubscribeGet(channels);
