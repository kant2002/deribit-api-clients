...
/*
MarketDataApiService Retrieves the summary information such as open interest, 24h volume, etc. for all instruments for the currency (optionally filtered by kind).
...
/*
MarketDataApiService Retrieve the latest user trades that have occurred for PERPETUAL instruments in a specific currency symbol and within given time range.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
...
/*
MarketDataApiService Retrieves available trading instruments. This method can be used to see which instruments are available for trading, or which instruments have existed historically.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
/*
MarketDataApiService Retrieves historical settlement, delivery and bankruptcy events coming from all instruments within given currency.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
/*
MarketDataApiService Retrieves historical public settlement, delivery and bankruptcy events filtered by instrument name.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
...
/*
MarketDataApiService Retrieve the latest trades that have occurred for instruments in a specific currency symbol and within given time range.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
/*
MarketDataApiService Retrieve the latest trades that have occurred for instruments in a specific currency symbol.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
/*
MarketDataApiService Retrieve the latest trades that have occurred for a specific instrument and within given time range.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
 * @param startTimestamp The earliest timestamp to return result for
 * @param endTimestamp The most recent timestamp to return result for
...
/*
MarketDataApiService Retrieve the latest trades that have occurred for a specific instrument.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
...
/*
MarketDataApiService Retrieves the order book, along with other market values for a given instrument.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
