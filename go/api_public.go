 ...
 * @param optional nil or *PublicAuthGetOpts - Optional Parameters:
 * @param "Nonce" (optional.String) -  Optional for grant type `client_signature`; delivers user generated initialization vector for the server token
 * @param "State" (optional.String) -  Will be passed back in the response
 * @param "Scope" (optional.String) -  Describes type of the access for assigned token, possible values: `connection`, `session`, `session:name`, `trade:[read, read_write, none]`, `wallet:[read, read_write, none]`, `account:[read, read_write, none]`, `expires:NUMBER` (token will expire after `NUMBER` of seconds).</BR></BR> **NOTICE:** Depending on choosing an authentication method (```grant type```) some scopes could be narrowed by the server. e.g. when ```grant_type = client_credentials``` and ```scope = wallet:read_write``` it's modified by the server as ```scope = wallet:read```
...
func (a *PublicApiService) PublicAuthGet(ctx context.Context, grantType string, username string, password string, clientId string, clientSecret string, refreshToken string, timestamp string, signature string, localVarOptionals *PublicAuthGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/public/auth"
...
/*
PublicApiService Stop sending heartbeat messages.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return map[string]interface{}
*/
func (a *PublicApiService) PublicDisableHeartbeatGet(ctx context.Context) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PublicApiService Retrieves the summary information such as open interest, 24h volume, etc. for all instruments for the currency (optionally filtered by kind).
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 * @param optional nil or *PublicGetBookSummaryByCurrencyGetOpts - Optional Parameters:
...
func (a *PublicApiService) PublicGetBookSummaryByCurrencyGet(ctx context.Context, currency string, localVarOptionals *PublicGetBookSummaryByCurrencyGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_book_summary_by_currency"
...
func (a *PublicApiService) PublicGetBookSummaryByInstrumentGet(ctx context.Context, instrumentName string) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_book_summary_by_instrument"
...
func (a *PublicApiService) PublicGetContractSizeGet(ctx context.Context, instrumentName string) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_contract_size"
...
func (a *PublicApiService) PublicGetCurrenciesGet(ctx context.Context) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_currencies"
...
/*
PublicApiService Retrieve the latest user trades that have occurred for PERPETUAL instruments in a specific currency symbol and within given time range.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
 * @param optional nil or *PublicGetFundingChartDataGetOpts - Optional Parameters:
 * @param "Length" (optional.String) -  Specifies time period. `8h` - 8 hours, `24h` - 24 hours
@return map[string]interface{}
*/
...
func (a *PublicApiService) PublicGetFundingChartDataGet(ctx context.Context, instrumentName string, localVarOptionals *PublicGetFundingChartDataGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_funding_chart_data"
...
func (a *PublicApiService) PublicGetHistoricalVolatilityGet(ctx context.Context, currency string) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_historical_volatility"
...
func (a *PublicApiService) PublicGetIndexGet(ctx context.Context, currency string) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_index"
...
/*
PublicApiService Retrieves available trading instruments. This method can be used to see which instruments are available for trading, or which instruments have existed historically.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 * @param optional nil or *PublicGetInstrumentsGetOpts - Optional Parameters:
 * @param "Kind" (optional.String) -  Instrument kind, if not provided instruments of all kinds are considered
 * @param "Expired" (optional.Bool) -  Set to true to show expired instruments instead of active ones.
@return map[string]interface{}
*/
...
func (a *PublicApiService) PublicGetInstrumentsGet(ctx context.Context, currency string, localVarOptionals *PublicGetInstrumentsGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_instruments"
...
/*
PublicApiService Retrieves historical settlement, delivery and bankruptcy events coming from all instruments within given currency.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 * @param optional nil or *PublicGetLastSettlementsByCurrencyGetOpts - Optional Parameters:
 * @param "Type_" (optional.String) -  Settlement type
 * @param "Count" (optional.Int32) -  Number of requested items, default - `20`
 * @param "Continuation" (optional.String) -  Continuation token for pagination
 * @param "SearchStartTimestamp" (optional.Int32) -  The latest timestamp to return result for
@return map[string]interface{}
*/
...
func (a *PublicApiService) PublicGetLastSettlementsByCurrencyGet(ctx context.Context, currency string, localVarOptionals *PublicGetLastSettlementsByCurrencyGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_last_settlements_by_currency"
	...
	if localVarOptionals != nil && localVarOptionals.SearchStartTimestamp.IsSet() {
		localVarQueryParams.Add("search_start_timestamp", parameterToString(localVarOptionals.SearchStartTimestamp.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
PublicApiService Retrieves historical public settlement, delivery and bankruptcy events filtered by instrument name.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
 * @param optional nil or *PublicGetLastSettlementsByInstrumentGetOpts - Optional Parameters:
 * @param "Type_" (optional.String) -  Settlement type
 * @param "Count" (optional.Int32) -  Number of requested items, default - `20`
 * @param "Continuation" (optional.String) -  Continuation token for pagination
 * @param "SearchStartTimestamp" (optional.Int32) -  The latest timestamp to return result for
...
func (a *PublicApiService) PublicGetLastSettlementsByInstrumentGet(ctx context.Context, instrumentName string, localVarOptionals *PublicGetLastSettlementsByInstrumentGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_last_settlements_by_instrument"
...
/*
PublicApiService Retrieve the latest trades that have occurred for instruments in a specific currency symbol and within given time range.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 ...
 * @param optional nil or *PublicGetLastTradesByCurrencyAndTimeGetOpts - Optional Parameters:
 * @param "Kind" (optional.String) -  Instrument kind, if not provided instruments of all kinds are considered
...
func (a *PublicApiService) PublicGetLastTradesByCurrencyAndTimeGet(ctx context.Context, currency string, startTimestamp int32, endTimestamp int32, localVarOptionals *PublicGetLastTradesByCurrencyAndTimeGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_last_trades_by_currency_and_time"
...
/*
PublicApiService Retrieve the latest trades that have occurred for instruments in a specific currency symbol.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 * @param optional nil or *PublicGetLastTradesByCurrencyGetOpts - Optional Parameters:
 * @param "Kind" (optional.String) -  Instrument kind, if not provided instruments of all kinds are considered
...
func (a *PublicApiService) PublicGetLastTradesByCurrencyGet(ctx context.Context, currency string, localVarOptionals *PublicGetLastTradesByCurrencyGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_last_trades_by_currency"
...
/*
PublicApiService Retrieve the latest trades that have occurred for a specific instrument and within given time range.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
 * @param startTimestamp The earliest timestamp to return result for
 * @param endTimestamp The most recent timestamp to return result for
 * @param optional nil or *PublicGetLastTradesByInstrumentAndTimeGetOpts - Optional Parameters:
 * @param "Count" (optional.Int32) -  Number of requested items, default - `10`
 * @param "IncludeOld" (optional.Bool) -  Include trades older than 7 days, default - `false`
 * @param "Sorting" (optional.String) -  Direction of results sorting (`default` value means no sorting, results will be returned in order in which they left the database)
@return map[string]interface{}
...
func (a *PublicApiService) PublicGetLastTradesByInstrumentAndTimeGet(ctx context.Context, instrumentName string, startTimestamp int32, endTimestamp int32, localVarOptionals *PublicGetLastTradesByInstrumentAndTimeGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_last_trades_by_instrument_and_time"
...
/*
PublicApiService Retrieve the latest trades that have occurred for a specific instrument.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
 * @param optional nil or *PublicGetLastTradesByInstrumentGetOpts - Optional Parameters:
...
func (a *PublicApiService) PublicGetLastTradesByInstrumentGet(ctx context.Context, instrumentName string, localVarOptionals *PublicGetLastTradesByInstrumentGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_last_trades_by_instrument"
...
/*
PublicApiService Retrieves the order book, along with other market values for a given instrument.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 ...
 * @param optional nil or *PublicGetOrderBookGetOpts - Optional Parameters:
 * @param "Depth" (optional.Float32) -  The number of entries to return for bids and asks.
@return map[string]interface{}
*/
...
func (a *PublicApiService) PublicGetOrderBookGet(ctx context.Context, instrumentName string, localVarOptionals *PublicGetOrderBookGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_order_book"
...
func (a *PublicApiService) PublicGetTimeGet(ctx context.Context) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_time"
...
func (a *PublicApiService) PublicGetTradeVolumesGet(ctx context.Context) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_trade_volumes"
...
func (a *PublicApiService) PublicGetTradingviewChartDataGet(ctx context.Context, instrumentName string, startTimestamp int32, endTimestamp int32) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/get_tradingview_chart_data"
...
/*
PublicApiService Method used to introduce the client software connected to Deribit platform over websocket. Provided data may have an impact on the maintained connection and will be collected for internal statistical purposes. In response, Deribit will also introduce itself.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clientName Client software name
 * @param clientVersion Client software version
@return map[string]interface{}
*/
func (a *PublicApiService) PublicHelloGet(ctx context.Context, clientName string, clientVersion string) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return map[string]interface{}
*/
func (a *PublicApiService) PublicSetHeartbeatGet(ctx context.Context, interval float32) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PublicApiService Subscribe to one or more channels.
Subscribe to one or more channels.  This is the same method as [/private/subscribe](#private_subscribe), but it can only be used for &#39;public&#39; channels. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param channels A list of channels to subscribe to.
@return map[string]interface{}
*/
func (a *PublicApiService) PublicSubscribeGet(ctx context.Context, channels []string) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PublicApiService Tests the connection to the API server, and returns its version. You can use this to make sure the API is reachable, and matches the expected version.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PublicTestGetOpts - Optional Parameters:
 * @param "ExpectedResult" (optional.String) -  The value \"exception\" will trigger an error response. This may be useful for testing wrapper libraries.
@return map[string]interface{}
*/
...
func (a *PublicApiService) PublicTestGet(ctx context.Context, localVarOptionals *PublicTestGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/test"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.ExpectedResult.IsSet() {
		localVarQueryParams.Add("expected_result", parameterToString(localVarOptionals.ExpectedResult.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
func (a *PublicApiService) PublicTickerGet(ctx context.Context, instrumentName string) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/ticker"
 ...
 * @param optional nil or *PublicValidateFieldGetOpts - Optional Parameters:
 * @param "Value2" (optional.String) -  Additional value to be compared with
@return map[string]interface{}
*/
...
func (a *PublicApiService) PublicValidateFieldGet(ctx context.Context, field string, value string, localVarOptionals *PublicValidateFieldGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/public/validate_field"
	...
	if localVarOptionals != nil && localVarOptionals.Value2.IsSet() {
		localVarQueryParams.Add("value2", parameterToString(localVarOptionals.Value2.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
