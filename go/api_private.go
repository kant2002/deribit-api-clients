...
/*
PrivateApiService Adds new entry to address book of given type
 ...
 * @param optional nil or *PrivateAddToAddressBookGetOpts - Optional Parameters:
 * @param "Tfa" (optional.String) -  TFA code, required when TFA is enabled for current account
...
func (a *PrivateApiService) PrivateAddToAddressBookGet(ctx context.Context, currency string, type_ string, address string, name string, localVarOptionals *PrivateAddToAddressBookGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/private/add_to_address_book"
	...
	if localVarOptionals != nil && localVarOptionals.Tfa.IsSet() {
		localVarQueryParams.Add("tfa", parameterToString(localVarOptionals.Tfa.Value(), ""))
	}
...
/*
PrivateApiService Places a buy order for an instrument.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
PrivateApiService Cancels all orders by currency, optionally filtered by instrument kind and/or order type.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
/*
PrivateApiService Cancels all orders by instrument, optionally filtered by order type.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
...
/*
PrivateApiService Cancel transfer
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 * @param id Id of transfer
 * @param optional nil or *PrivateCancelTransferByIdGetOpts - Optional Parameters:
 * @param "Tfa" (optional.String) -  TFA code, required when TFA is enabled for current account
@return map[string]interface{}
*/
...
func (a *PrivateApiService) PrivateCancelTransferByIdGet(ctx context.Context, currency string, id int32, localVarOptionals *PrivateCancelTransferByIdGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/cancel_transfer_by_id"
...
func (a *PrivateApiService) PrivateCancelWithdrawalGet(ctx context.Context, currency string, id float32) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/cancel_withdrawal"
...
/*
PrivateApiService Makes closing position reduce only order .
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
...
func (a *PrivateApiService) PrivateCreateDepositAddressGet(ctx context.Context, currency string) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/create_deposit_address"
...
/*
PrivateApiService Disable Cancel On Disconnect for the connection. This does not change the default account setting.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return map[string]interface{}
*/
func (a *PrivateApiService) PrivateDisableCancelOnDisconnectGet(ctx context.Context) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *PrivateApiService) PrivateDisableTfaWithRecoveryCodeGet(ctx context.Context, password string, code string) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/disable_tfa_with_recovery_code"
...
/*
PrivateApiService Change price, amount and/or other properties of an order.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orderId The order id
 * @param amount It represents the requested order size. For perpetual and futures the amount is in USD units, for options it is amount of corresponding cryptocurrency contracts, e.g., BTC or ETH
...
/*
PrivateApiService Enable Cancel On Disconnect for the connection. This does not change the default account setting.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return map[string]interface{}
*/
func (a *PrivateApiService) PrivateEnableCancelOnDisconnectGet(ctx context.Context) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PrivateApiService Retrieves user account summary.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
func (a *PrivateApiService) PrivateGetAddressBookGet(ctx context.Context, currency string, type_ string) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/get_address_book"
...
func (a *PrivateApiService) PrivateGetCurrentDepositAddressGet(ctx context.Context, currency string) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/get_current_deposit_address"
...
/*
PrivateApiService Retrieve the latest users deposits
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 * @param optional nil or *PrivateGetDepositsGetOpts - Optional Parameters:
...
func (a *PrivateApiService) PrivateGetDepositsGet(ctx context.Context, currency string, localVarOptionals *PrivateGetDepositsGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/get_deposits"
...
/*
PrivateApiService Retrieves list of user's open orders.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
/*
PrivateApiService Retrieves list of user's open orders within given Instrument.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
...
/*
PrivateApiService Retrieves history of orders that have been partially or fully filled.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
/*
PrivateApiService Retrieve user positions.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency
...
/*
PrivateApiService Retrieves settlement, delivery and bankruptcy events that have affected your account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
/*
PrivateApiService Retrieves public settlement, delivery and bankruptcy events filtered by instrument name
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
...
/*
PrivateApiService Get information about subaccounts
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 * @param optional nil or *PrivateGetTransfersGetOpts - Optional Parameters:
 * @param "Count" (optional.Int32) -  Number of requested items, default - `10`
 * @param "Offset" (optional.Int32) -  The offset for pagination, default - `0`
@return map[string]interface{}
*/
...
func (a *PrivateApiService) PrivateGetTransfersGet(ctx context.Context, currency string, localVarOptionals *PrivateGetTransfersGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/get_transfers"
...
/*
PrivateApiService Retrieve the latest user trades that have occurred for instruments in a specific currency symbol and within given time range.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
/*
PrivateApiService Retrieve the latest user trades that have occurred for instruments in a specific currency symbol.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
...
/*
PrivateApiService Retrieve the latest user trades that have occurred for a specific instrument and within given time range.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
 * @param startTimestamp The earliest timestamp to return result for
 * @param endTimestamp The most recent timestamp to return result for
...
/*
PrivateApiService Retrieve the latest user trades that have occurred for a specific instrument.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
...
/*
PrivateApiService Retrieve the list of user trades that was created for given order
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orderId The order id
...
/*
PrivateApiService Retrieve the latest users withdrawals
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 * @param optional nil or *PrivateGetWithdrawalsGetOpts - Optional Parameters:
 * @param "Count" (optional.Int32) -  Number of requested items, default - `10`
 * @param "Offset" (optional.Int32) -  The offset for pagination, default - `0`
@return map[string]interface{}
*/
...
func (a *PrivateApiService) PrivateGetWithdrawalsGet(ctx context.Context, currency string, localVarOptionals *PrivateGetWithdrawalsGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/get_withdrawals"
...
/*
PrivateApiService Gracefully close websocket connection, when COD (Cancel On Disconnect) is enabled orders are not cancelled
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
*/
func (a *PrivateApiService) PrivateLogoutGet(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param type_ Address book type
 * @param address Address in currency format, it must be in address book
 * @param optional nil or *PrivateRemoveFromAddressBookGetOpts - Optional Parameters:
 * @param "Tfa" (optional.String) -  TFA code, required when TFA is enabled for current account
@return map[string]interface{}
*/
...
func (a *PrivateApiService) PrivateRemoveFromAddressBookGet(ctx context.Context, currency string, type_ string, address string, localVarOptionals *PrivateRemoveFromAddressBookGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/remove_from_address_book"
...
/*
PrivateApiService Places a sell order for an instrument.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param instrumentName Instrument name
 * @param amount It represents the requested order size. For perpetual and futures the amount is in USD units, for options it is amount of corresponding cryptocurrency contracts, e.g., BTC or ETH
...
func (a *PrivateApiService) PrivateSubmitTransferToSubaccountGet(ctx context.Context, currency string, amount float32, destination int32) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/submit_transfer_to_subaccount"
...
/*
PrivateApiService Transfer funds to a another user.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 * @param amount Amount of funds to be transferred
 * @param destination Destination address from address book
 * @param optional nil or *PrivateSubmitTransferToUserGetOpts - Optional Parameters:
 * @param "Tfa" (optional.String) -  TFA code, required when TFA is enabled for current account
@return map[string]interface{}
*/
...
func (a *PrivateApiService) PrivateSubmitTransferToUserGet(ctx context.Context, currency string, amount float32, destination string, localVarOptionals *PrivateSubmitTransferToUserGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/submit_transfer_to_user"
...
/*
PrivateApiService Subscribe to one or more channels.
Subscribe to one or more channels.  The name of the channel determines what information will be provided, and in what form. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param channels A list of channels to subscribe to.
@return map[string]interface{}
*/
func (a *PrivateApiService) PrivateSubscribeGet(ctx context.Context, channels []string) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (a *PrivateApiService) PrivateToggleDepositAddressCreationGet(ctx context.Context, currency string, state bool) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/toggle_deposit_address_creation"
...
/*
PrivateApiService Unsubscribe from one or more channels.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param channels A list of channels to unsubscribe from.
@return map[string]interface{}
*/
func (a *PrivateApiService) PrivateUnsubscribeGet(ctx context.Context, channels []string) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod   = strings.ToUpper("Get")
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PrivateApiService Creates a new withdrawal request
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param currency The currency symbol
 * @param address Address in currency format, it must be in address book
 * @param amount Amount of funds to be withdrawn
 * @param optional nil or *PrivateWithdrawGetOpts - Optional Parameters:
 * @param "Priority" (optional.String) -  Withdrawal priority, optional for BTC, default: `high`
 * @param "Tfa" (optional.String) -  TFA code, required when TFA is enabled for current account
@return map[string]interface{}
*/
...
func (a *PrivateApiService) PrivateWithdrawGet(ctx context.Context, currency string, address string, amount float32, localVarOptionals *PrivateWithdrawGetOpts) (map[string]interface{}, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/private/withdraw"
