...
OAIBook_summary::asJsonObject() const {
	...
	if(estimated_delivery_price.isSet()){
...
void
OAIBook_summary::setVolume(const OAINumber &volume) {
    this->volume = volume;
...
void
OAIBook_summary::setVolumeUsd(const OAINumber &volume_usd) {
...
void
OAIBook_summary::setUnderlyingPrice(const OAINumber &underlying_price) {
...
void
OAIBook_summary::setBidPrice(const OAINumber &bid_price) {
...
void
OAIBook_summary::setOpenInterest(const OAINumber &open_interest) {
...
void
OAIBook_summary::setHigh(const OAINumber &high) {
    this->high = high;
...
void
OAIBook_summary::setEstimatedDeliveryPrice(const OAINumber &estimated_delivery_price) {
...
void
OAIBook_summary::setLast(const OAINumber &last) {
    this->last = last;
...
void
OAIBook_summary::setMidPrice(const OAINumber &mid_price) {
...
void
OAIBook_summary::setInterestRate(const OAINumber &interest_rate) {
...
void
OAIBook_summary::setFunding8h(const OAINumber &funding_8h) {
...
void
OAIBook_summary::setMarkPrice(const OAINumber &mark_price) {
...
void
OAIBook_summary::setAskPrice(const OAINumber &ask_price) {
...
void
OAIBook_summary::setLow(const OAINumber &low) {
    this->low = low;
...
void
OAIBook_summary::setCurrentFunding(const OAINumber &current_funding) {
...
OAIBook_summary::isSet() const {
    ...
    do{ 
        ...
        if(volume.isSet()){ isObjectUpdated = true; break;}
    
        if(volume_usd.isSet()){ isObjectUpdated = true; break;}
    
        if(underlying_price.isSet()){ isObjectUpdated = true; break;}
    
        if(bid_price.isSet()){ isObjectUpdated = true; break;}
    
        if(open_interest.isSet()){ isObjectUpdated = true; break;}
    
        if(m_quote_currency_isSet){ isObjectUpdated = true; break;}
    
        if(high.isSet()){ isObjectUpdated = true; break;}
    
        if(estimated_delivery_price.isSet()){ isObjectUpdated = true; break;}
    
        if(last.isSet()){ isObjectUpdated = true; break;}
    
        if(mid_price.isSet()){ isObjectUpdated = true; break;}
    
        if(interest_rate.isSet()){ isObjectUpdated = true; break;}
    
        if(funding_8h.isSet()){ isObjectUpdated = true; break;}
    
        if(mark_price.isSet()){ isObjectUpdated = true; break;}
    
        if(ask_price.isSet()){ isObjectUpdated = true; break;}
    
        if(m_instrument_name_isSet){ isObjectUpdated = true; break;}
    
        if(low.isSet()){ isObjectUpdated = true; break;}
    
        if(m_base_currency_isSet){ isObjectUpdated = true; break;}
    
        if(m_creation_timestamp_isSet){ isObjectUpdated = true; break;}
    
        if(current_funding.isSet()){ isObjectUpdated = true; break;}
    }while(false);
