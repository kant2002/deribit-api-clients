...
void
OAIUser_trade::setPrice(const OAINumber &price) {
    this->price = price;
...
void
OAIUser_trade::setIv(const OAINumber &iv) {
    this->iv = iv;
...
void
OAIUser_trade::setFee(const OAINumber &fee) {
    this->fee = fee;
...
void
OAIUser_trade::setIndexPrice(const OAINumber &index_price) {
...
void
OAIUser_trade::setAmount(const OAINumber &amount) {
    this->amount = amount;
...
OAIUser_trade::isSet() const {
    ...
    do{ 
        ...
        if(fee.isSet()){ isObjectUpdated = true; break;}
