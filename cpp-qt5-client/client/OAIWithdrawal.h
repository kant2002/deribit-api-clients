...
class OAIWithdrawal: public OAIObject {
public:
    OAIWithdrawal();
    OAIWithdrawal(QString json);
    ~OAIWithdrawal() override;
    ...
    OAINumber getFee() const;
    void setFee(const OAINumber &fee);

    
    qint32 getConfirmedTimestamp() const;
    void setConfirmedTimestamp(const qint32 &confirmed_timestamp);
    ...
    OAINumber getPriority() const;
    void setPriority(const OAINumber &priority);
...
private:
    ...
    qint32 confirmed_timestamp;
    bool m_confirmed_timestamp_isSet;
    bool m_confirmed_timestamp_isValid;
