...
OAIMarketDataApi::OAIMarketDataApi(QString host, QString basePath) {
    this->host = host;
...
void
OAIMarketDataApi::publicGetOrderBookGet(const QString& instrument_name, const OAINumber& depth) {
    QString fullPath;
