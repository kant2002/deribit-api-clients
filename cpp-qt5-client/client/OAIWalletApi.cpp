...
OAIWalletApi::OAIWalletApi(QString host, QString basePath) {
    this->host = host;
...
void
OAIWalletApi::privateCancelWithdrawalGet(const QString& currency, const OAINumber& id) {
    QString fullPath;
...
void
OAIWalletApi::privateSubmitTransferToSubaccountGet(const QString& currency, const OAINumber& amount, const qint32& destination) {
    QString fullPath;
...
void
OAIWalletApi::privateSubmitTransferToUserGet(const QString& currency, const OAINumber& amount, const QString& destination, const QString& tfa) {
    QString fullPath;
...
void
OAIWalletApi::privateWithdrawGet(const QString& currency, const QString& address, const OAINumber& amount, const QString& priority, const QString& tfa) {
    QString fullPath;
