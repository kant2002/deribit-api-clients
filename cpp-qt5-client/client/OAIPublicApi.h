...
public:
    OAIPublicApi();
    OAIPublicApi(QString host, QString basePath);
    ~OAIPublicApi();
    ...
    void publicAuthGet(const QString& grant_type, const QString& username, const QString& password, const QString& client_id, const QString& client_secret, const QString& refresh_token, const QString& timestamp, const QString& signature, const QString& nonce, const QString& state, const QString& scope);
    ...
    void publicGetOrderBookGet(const QString& instrument_name, const OAINumber& depth);
    void publicGetTimeGet();
    ...
    void publicTestGet(const QString& expected_result);
    void publicTickerGet(const QString& instrument_name);
    void publicValidateFieldGet(const QString& field, const QString& value, const QString& value2);
    
private:
    void publicAuthGetCallback (OAIHttpRequestWorker * worker);
    ...
    void publicGetTimeGetCallback (OAIHttpRequestWorker * worker);
    ...
    void publicTestGetCallback (OAIHttpRequestWorker * worker);
    void publicTickerGetCallback (OAIHttpRequestWorker * worker);
    void publicValidateFieldGetCallback (OAIHttpRequestWorker * worker);
    
signals:
    void publicAuthGetSignal(OAIObject summary);
    ...
    void publicGetTimeGetSignal(OAIObject summary);
    ...
    void publicTestGetSignal(OAIObject summary);
    void publicTickerGetSignal(OAIObject summary);
    void publicValidateFieldGetSignal(OAIObject summary);
    
    void publicAuthGetSignalFull(OAIHttpRequestWorker* worker, OAIObject summary);
    ...
    void publicGetTimeGetSignalFull(OAIHttpRequestWorker* worker, OAIObject summary);
    ...
    void publicTestGetSignalFull(OAIHttpRequestWorker* worker, OAIObject summary);
    void publicTickerGetSignalFull(OAIHttpRequestWorker* worker, OAIObject summary);
    void publicValidateFieldGetSignalFull(OAIHttpRequestWorker* worker, OAIObject summary);
    
    void publicAuthGetSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString& error_str);
    ...
    void publicGetTimeGetSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString& error_str);
    ...
    void publicTestGetSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString& error_str);
    void publicTickerGetSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString& error_str);
    void publicValidateFieldGetSignalE(OAIObject summary, QNetworkReply::NetworkError error_type, QString& error_str);
    
    void publicAuthGetSignalEFull(OAIHttpRequestWorker* worker, QNetworkReply::NetworkError error_type, QString& error_str);
    ...
    void publicGetTimeGetSignalEFull(OAIHttpRequestWorker* worker, QNetworkReply::NetworkError error_type, QString& error_str);
    ...
    void publicTestGetSignalEFull(OAIHttpRequestWorker* worker, QNetworkReply::NetworkError error_type, QString& error_str);
    void publicTickerGetSignalEFull(OAIHttpRequestWorker* worker, QNetworkReply::NetworkError error_type, QString& error_str);
    void publicValidateFieldGetSignalEFull(OAIHttpRequestWorker* worker, QNetworkReply::NetworkError error_type, QString& error_str);
