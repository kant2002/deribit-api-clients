...
void
OAIOrder::setPrice(const OAINumber &price) {
    this->price = price;
...
void
OAIOrder::setImplv(const OAINumber &implv) {
    this->implv = implv;
...
void
OAIOrder::setUsd(const OAINumber &usd) {
    this->usd = usd;
...
void
OAIOrder::setStopPrice(const OAINumber &stop_price) {
...
void
OAIOrder::setMaxShow(const OAINumber &max_show) {
...
void
OAIOrder::setProfitLoss(const OAINumber &profit_loss) {
...
void
OAIOrder::setFilledAmount(const OAINumber &filled_amount) {
...
void
OAIOrder::setCommission(const OAINumber &commission) {
...
void
OAIOrder::setAmount(const OAINumber &amount) {
    this->amount = amount;
...
void
OAIOrder::setAveragePrice(const OAINumber &average_price) {
...
OAIOrder::isSet() const {
    ...
    do{ 
        ...
        if(implv.isSet()){ isObjectUpdated = true; break;}
    
        if(m_advanced_isSet){ isObjectUpdated = true; break;}
    
        if(m_post_only_isSet){ isObjectUpdated = true; break;}
    
        if(usd.isSet()){ isObjectUpdated = true; break;}
    
        if(stop_price.isSet()){ isObjectUpdated = true; break;}
