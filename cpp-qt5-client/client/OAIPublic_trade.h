...
class OAIPublic_trade: public OAIObject {
public:
    OAIPublic_trade();
    OAIPublic_trade(QString json);
    ~OAIPublic_trade() override;
    ...
    OAINumber getIv() const;
    void setIv(const OAINumber &iv);
