...
OAIPrivateApi::OAIPrivateApi(QString host, QString basePath) {
    this->host = host;
...
void
OAIPrivateApi::privateCancelWithdrawalGet(const QString& currency, const OAINumber& id) {
    QString fullPath;
...
void
OAIPrivateApi::privateClosePositionGet(const QString& instrument_name, const QString& type, const OAINumber& price) {
    QString fullPath;
...
void
OAIPrivateApi::privateDisableCancelOnDisconnectGet() {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIPrivateApi::privateDisableCancelOnDisconnectGetCallback);

    worker->execute(&input);
}

void
OAIPrivateApi::privateDisableCancelOnDisconnectGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIPrivateApi::privateEditGet(const QString& order_id, const OAINumber& amount, const OAINumber& price, const bool& post_only, const QString& advanced, const OAINumber& stop_price) {
    QString fullPath;
...
void
OAIPrivateApi::privateEnableCancelOnDisconnectGet() {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIPrivateApi::privateEnableCancelOnDisconnectGetCallback);

    worker->execute(&input);
}

void
OAIPrivateApi::privateEnableCancelOnDisconnectGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIPrivateApi::privateGetMarginsGet(const QString& instrument_name, const OAINumber& amount, const OAINumber& price) {
    QString fullPath;
...
void
OAIPrivateApi::privateLogoutGet() {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIPrivateApi::privateLogoutGetCallback);

    worker->execute(&input);
}

void
OAIPrivateApi::privateLogoutGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIPrivateApi::privateSellGet(const QString& instrument_name, const OAINumber& amount, const QString& type, const QString& label, const OAINumber& price, const QString& time_in_force, const OAINumber& max_show, const bool& post_only, const bool& reduce_only, const OAINumber& stop_price, const QString& trigger, const QString& advanced) {
    QString fullPath;
...
void
OAIPrivateApi::privateSetAnnouncementAsReadGet(const OAINumber& announcement_id) {
    QString fullPath;
...
void
OAIPrivateApi::privateSubmitTransferToSubaccountGet(const QString& currency, const OAINumber& amount, const qint32& destination) {
    QString fullPath;
...
void
OAIPrivateApi::privateSubmitTransferToUserGet(const QString& currency, const OAINumber& amount, const QString& destination, const QString& tfa) {
    QString fullPath;
...
void
OAIPrivateApi::privateSubscribeGet(const QList<QString>& channels) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIPrivateApi::privateSubscribeGetCallback);

    worker->execute(&input);
}

void
OAIPrivateApi::privateSubscribeGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIPrivateApi::privateUnsubscribeGet(const QList<QString>& channels) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIPrivateApi::privateUnsubscribeGetCallback);

    worker->execute(&input);
}

void
OAIPrivateApi::privateUnsubscribeGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIPrivateApi::privateWithdrawGet(const QString& currency, const QString& address, const OAINumber& amount, const QString& priority, const QString& tfa) {
    QString fullPath;
