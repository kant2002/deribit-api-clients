...
void
OAIPosition::setAveragePriceUsd(const OAINumber &average_price_usd) {
...
void
OAIPosition::setEstimatedLiquidationPrice(const OAINumber &estimated_liquidation_price) {
...
void
OAIPosition::setFloatingProfitLoss(const OAINumber &floating_profit_loss) {
...
void
OAIPosition::setFloatingProfitLossUsd(const OAINumber &floating_profit_loss_usd) {
...
void
OAIPosition::setOpenOrdersMargin(const OAINumber &open_orders_margin) {
...
void
OAIPosition::setTotalProfitLoss(const OAINumber &total_profit_loss) {
...
void
OAIPosition::setRealizedProfitLoss(const OAINumber &realized_profit_loss) {
...
void
OAIPosition::setDelta(const OAINumber &delta) {
    this->delta = delta;
...
void
OAIPosition::setInitialMargin(const OAINumber &initial_margin) {
...
void
OAIPosition::setSize(const OAINumber &size) {
    this->size = size;
...
void
OAIPosition::setMaintenanceMargin(const OAINumber &maintenance_margin) {
...
void
OAIPosition::setMarkPrice(const OAINumber &mark_price) {
...
void
OAIPosition::setAveragePrice(const OAINumber &average_price) {
...
void
OAIPosition::setSettlementPrice(const OAINumber &settlement_price) {
...
void
OAIPosition::setIndexPrice(const OAINumber &index_price) {
...
void
OAIPosition::setSizeCurrency(const OAINumber &size_currency) {
...
OAIPosition::isSet() const {
    ...
    do{ 
        ...
        if(average_price_usd.isSet()){ isObjectUpdated = true; break;}
    
        if(estimated_liquidation_price.isSet()){ isObjectUpdated = true; break;}
    
        if(floating_profit_loss.isSet()){ isObjectUpdated = true; break;}
    
        if(floating_profit_loss_usd.isSet()){ isObjectUpdated = true; break;}
    
        if(open_orders_margin.isSet()){ isObjectUpdated = true; break;}
    
        if(total_profit_loss.isSet()){ isObjectUpdated = true; break;}
    
        if(realized_profit_loss.isSet()){ isObjectUpdated = true; break;}
    
        if(delta.isSet()){ isObjectUpdated = true; break;}
        ...
        if(average_price.isSet()){ isObjectUpdated = true; break;}
    
        if(settlement_price.isSet()){ isObjectUpdated = true; break;}
    
        if(index_price.isSet()){ isObjectUpdated = true; break;}
    
        if(m_instrument_name_isSet){ isObjectUpdated = true; break;}
    
        if(size_currency.isSet()){ isObjectUpdated = true; break;}
    }while(false);
