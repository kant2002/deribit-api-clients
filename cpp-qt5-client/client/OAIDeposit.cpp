...
void
OAIDeposit::fromJson(QString jsonString) {
...
void
OAIDeposit::fromJsonObject(QJsonObject json) {
...
qint32
OAIDeposit::getUpdatedTimestamp() const {
    return updated_timestamp;
}
void
OAIDeposit::setUpdatedTimestamp(const qint32 &updated_timestamp) {
...
QString
OAIDeposit::getState() const {
    return state;
}
void
OAIDeposit::setState(const QString &state) {
    this->state = state;
...
qint32
OAIDeposit::getReceivedTimestamp() const {
    return received_timestamp;
}
void
OAIDeposit::setReceivedTimestamp(const qint32 &received_timestamp) {
...
QString
OAIDeposit::getCurrency() const {
    return currency;
}
void
OAIDeposit::setCurrency(const QString &currency) {
...
QString
OAIDeposit::getAddress() const {
    return address;
}
void
OAIDeposit::setAddress(const QString &address) {
...
OAINumber
OAIDeposit::getAmount() const {
    return amount;
}
void
OAIDeposit::setAmount(const OAINumber &amount) {
    this->amount = amount;
...
QString
OAIDeposit::getTransactionId() const {
    return transaction_id;
}
void
OAIDeposit::setTransactionId(const QString &transaction_id) {
    this->transaction_id = transaction_id;
    this->m_transaction_id_isSet = true;
}

bool
OAIDeposit::isSet() const {
    ...
    do{ 
        ...
        if(m_received_timestamp_isSet){ isObjectUpdated = true; break;}
...
bool
OAIDeposit::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_updated_timestamp_isValid && m_state_isValid && m_received_timestamp_isValid && m_currency_isValid && m_address_isValid && m_amount_isValid && m_transaction_id_isValid && true;
}
