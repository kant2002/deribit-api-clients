...
OAIAuthenticationApi::OAIAuthenticationApi(QString host, QString basePath) {
    this->host = host;
    this->basePath = basePath;
}

void
OAIAuthenticationApi::privateLogoutGet() {
    QString fullPath;
    ...
    connect(worker,
            ...
            this,
            &OAIAuthenticationApi::privateLogoutGetCallback);

    worker->execute(&input);
}

void
OAIAuthenticationApi::privateLogoutGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
...
void
OAIAuthenticationApi::publicAuthGet(const QString& grant_type, const QString& username, const QString& password, const QString& client_id, const QString& client_secret, const QString& refresh_token, const QString& timestamp, const QString& signature, const QString& nonce, const QString& state, const QString& scope) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAuthenticationApi::publicAuthGetCallback);

    worker->execute(&input);
}

void
OAIAuthenticationApi::publicAuthGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
