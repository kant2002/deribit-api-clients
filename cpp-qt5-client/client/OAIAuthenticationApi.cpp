...
OAIAuthenticationApi::OAIAuthenticationApi() : basePath("/api/v2"),
...
OAIAuthenticationApi::OAIAuthenticationApi(const QString& host, const QString& basePath) {
    this->host = host;
    this->basePath = basePath;
}

void OAIAuthenticationApi::setBasePath(const QString& basePath){
    this->basePath = basePath;
}

void OAIAuthenticationApi::setHost(const QString& host){
    this->host = host;
}
