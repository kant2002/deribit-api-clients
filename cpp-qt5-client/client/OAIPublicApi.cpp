...
OAIPublicApi::OAIPublicApi(QString host, QString basePath) {
    this->host = host;
...
void
OAIPublicApi::publicDisableHeartbeatGet() {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIPublicApi::publicDisableHeartbeatGetCallback);

    worker->execute(&input);
}

void
OAIPublicApi::publicDisableHeartbeatGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIPublicApi::publicGetOrderBookGet(const QString& instrument_name, const OAINumber& depth) {
    QString fullPath;
...
void
OAIPublicApi::publicHelloGet(const QString& client_name, const QString& client_version) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIPublicApi::publicHelloGetCallback);

    worker->execute(&input);
}

void
OAIPublicApi::publicHelloGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIPublicApi::publicSetHeartbeatGet(const OAINumber& interval) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIPublicApi::publicSetHeartbeatGetCallback);

    worker->execute(&input);
}

void
OAIPublicApi::publicSetHeartbeatGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIPublicApi::publicSubscribeGet(const QList<QString>& channels) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIPublicApi::publicSubscribeGetCallback);

    worker->execute(&input);
}

void
OAIPublicApi::publicSubscribeGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
