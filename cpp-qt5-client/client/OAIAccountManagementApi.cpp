...
OAIAccountManagementApi::OAIAccountManagementApi() : basePath("/api/v2"),
    host("www.deribit.com") {

}

OAIAccountManagementApi::~OAIAccountManagementApi() {

}

OAIAccountManagementApi::OAIAccountManagementApi(const QString& host, const QString& basePath) {
    this->host = host;
    this->basePath = basePath;
}

void OAIAccountManagementApi::setBasePath(const QString& basePath){
    this->basePath = basePath;
}

void OAIAccountManagementApi::setHost(const QString& host){
    this->host = host;
}

void OAIAccountManagementApi::addHeaders(const QString& key, const QString& value){
    defaultHeaders.insert(key, value);
}


void
OAIAccountManagementApi::privateChangeSubaccountNameGet(const qint32& sid, const QString& name) {
    QString fullPath;
    ...
    connect(worker,
            ...
            this,
            &OAIAccountManagementApi::privateChangeSubaccountNameGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateChangeSubaccountNameGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
...
void
OAIAccountManagementApi::privateCreateSubaccountGet() {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateCreateSubaccountGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateCreateSubaccountGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateDisableTfaForSubaccountGet(const qint32& sid) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateDisableTfaForSubaccountGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateDisableTfaForSubaccountGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateGetAccountSummaryGet(const QString& currency, const bool& extended) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateGetAccountSummaryGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateGetAccountSummaryGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateGetEmailLanguageGet() {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateGetEmailLanguageGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateGetEmailLanguageGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateGetNewAnnouncementsGet() {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateGetNewAnnouncementsGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateGetNewAnnouncementsGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateGetPositionGet(const QString& instrument_name) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateGetPositionGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateGetPositionGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateGetPositionsGet(const QString& currency, const QString& kind) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateGetPositionsGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateGetPositionsGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateGetSubaccountsGet(const bool& with_portfolio) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateGetSubaccountsGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateGetSubaccountsGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateSetAnnouncementAsReadGet(const double& announcement_id) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateSetAnnouncementAsReadGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateSetAnnouncementAsReadGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateSetEmailForSubaccountGet(const qint32& sid, const QString& email) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateSetEmailForSubaccountGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateSetEmailForSubaccountGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateSetEmailLanguageGet(const QString& language) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateSetEmailLanguageGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateSetEmailLanguageGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateSetPasswordForSubaccountGet(const qint32& sid, const QString& password) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateSetPasswordForSubaccountGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateSetPasswordForSubaccountGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateToggleNotificationsFromSubaccountGet(const qint32& sid, const bool& state) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateToggleNotificationsFromSubaccountGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateToggleNotificationsFromSubaccountGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::privateToggleSubaccountLoginGet(const qint32& sid, const QString& state) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::privateToggleSubaccountLoginGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::privateToggleSubaccountLoginGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIAccountManagementApi::publicGetAnnouncementsGet() {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIAccountManagementApi::publicGetAnnouncementsGetCallback);

    worker->execute(&input);
}

void
OAIAccountManagementApi::publicGetAnnouncementsGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
