...
OAIAccountManagementApi::OAIAccountManagementApi(QString host, QString basePath) {
    this->host = host;
...
void
OAIAccountManagementApi::privateSetAnnouncementAsReadGet(const OAINumber& announcement_id) {
    QString fullPath;
