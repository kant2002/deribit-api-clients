...
OAIInternalApi::OAIInternalApi(QString host, QString basePath) {
    this->host = host;
...
void
OAIInternalApi::privateSubmitTransferToSubaccountGet(const QString& currency, const OAINumber& amount, const qint32& destination) {
    QString fullPath;
...
void
OAIInternalApi::privateSubmitTransferToUserGet(const QString& currency, const OAINumber& amount, const QString& destination, const QString& tfa) {
    QString fullPath;
