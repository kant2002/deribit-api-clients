...
OAIInternalApi::OAIInternalApi() : basePath("/api/v2"),
...
OAIInternalApi::OAIInternalApi(const QString& host, const QString& basePath) {
    this->host = host;
    this->basePath = basePath;
}

void OAIInternalApi::setBasePath(const QString& basePath){
    this->basePath = basePath;
}

void OAIInternalApi::setHost(const QString& host){
    this->host = host;
}
...
void
OAIInternalApi::privateAddToAddressBookGet(const QString& currency, const QString& type, const QString& address, const QString& name, const QString& tfa) {
    QString fullPath;
    ...
    connect(worker,
            ...
            this,
            &OAIInternalApi::privateAddToAddressBookGetCallback);

    worker->execute(&input);
}

void
OAIInternalApi::privateAddToAddressBookGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
...
void
OAIInternalApi::privateDisableTfaWithRecoveryCodeGet(const QString& password, const QString& code) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIInternalApi::privateDisableTfaWithRecoveryCodeGetCallback);

    worker->execute(&input);
}

void
OAIInternalApi::privateDisableTfaWithRecoveryCodeGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIInternalApi::privateGetAddressBookGet(const QString& currency, const QString& type) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIInternalApi::privateGetAddressBookGetCallback);

    worker->execute(&input);
}

void
OAIInternalApi::privateGetAddressBookGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIInternalApi::privateRemoveFromAddressBookGet(const QString& currency, const QString& type, const QString& address, const QString& tfa) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIInternalApi::privateRemoveFromAddressBookGetCallback);

    worker->execute(&input);
}

void
OAIInternalApi::privateRemoveFromAddressBookGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIInternalApi::privateSubmitTransferToSubaccountGet(const QString& currency, const double& amount, const qint32& destination) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIInternalApi::privateSubmitTransferToSubaccountGetCallback);

    worker->execute(&input);
}

void
OAIInternalApi::privateSubmitTransferToSubaccountGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIInternalApi::privateSubmitTransferToUserGet(const QString& currency, const double& amount, const QString& destination, const QString& tfa) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIInternalApi::privateSubmitTransferToUserGetCallback);

    worker->execute(&input);
}

void
OAIInternalApi::privateSubmitTransferToUserGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIInternalApi::privateToggleDepositAddressCreationGet(const QString& currency, const bool& state) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIInternalApi::privateToggleDepositAddressCreationGetCallback);

    worker->execute(&input);
}

void
OAIInternalApi::privateToggleDepositAddressCreationGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void
OAIInternalApi::publicGetFooterGet() {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/public/get_footer");
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIInternalApi::publicGetFooterGetCallback);

    worker->execute(&input);
}

void
OAIInternalApi::publicGetFooterGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit publicGetFooterGetSignal(output);
        emit publicGetFooterGetSignalFull(worker, output);
    } else {
        emit publicGetFooterGetSignalE(output, error_type, error_str);
        emit publicGetFooterGetSignalEFull(worker, error_type, error_str);
    }
}

void
OAIInternalApi::publicGetOptionMarkPricesGet(const QString& currency) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/public/get_option_mark_prices");
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIInternalApi::publicGetOptionMarkPricesGetCallback);

    worker->execute(&input);
}

void
OAIInternalApi::publicGetOptionMarkPricesGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        emit publicGetOptionMarkPricesGetSignal(output);
        emit publicGetOptionMarkPricesGetSignalFull(worker, output);
    } else {
        emit publicGetOptionMarkPricesGetSignalE(output, error_type, error_str);
        emit publicGetOptionMarkPricesGetSignalEFull(worker, error_type, error_str);
    }
}

void
OAIInternalApi::publicValidateFieldGet(const QString& field, const QString& value, const QString& value2) {
    QString fullPath;
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIInternalApi::publicValidateFieldGetCallback);

    worker->execute(&input);
}

void
OAIInternalApi::publicValidateFieldGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
