...
void
OAIInstrument::setTickSize(const OAINumber &tick_size) {
...
void
OAIInstrument::setMinTradeAmount(const OAINumber &min_trade_amount) {
...
void
OAIInstrument::setStrike(const OAINumber &strike) {
    this->strike = strike;
...
OAIInstrument::isSet() const {
    ...
    do{ 
        ...
        if(tick_size.isSet()){ isObjectUpdated = true; break;}
