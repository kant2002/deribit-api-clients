...
OAIPublic_trade::OAIPublic_trade(QString json) {
    this->init();
    this->fromJson(json);
}

OAIPublic_trade::OAIPublic_trade() {
    this->init();
}
...
void
OAIPublic_trade::fromJson(QString jsonString) {
...
void
OAIPublic_trade::fromJsonObject(QJsonObject json) {
...
QJsonObject
OAIPublic_trade::asJsonObject() const {
    QJsonObject obj;
...
QString
OAIPublic_trade::getDirection() const {
    return direction;
}
void
OAIPublic_trade::setDirection(const QString &direction) {
...
qint32
OAIPublic_trade::getTickDirection() const {
    return tick_direction;
}
void
OAIPublic_trade::setTickDirection(const qint32 &tick_direction) {
...
qint32
OAIPublic_trade::getTimestamp() const {
    return timestamp;
}
void
OAIPublic_trade::setTimestamp(const qint32 &timestamp) {
...
OAINumber
OAIPublic_trade::getPrice() const {
    return price;
}
void
OAIPublic_trade::setPrice(const OAINumber &price) {
    this->price = price;
...
qint32
OAIPublic_trade::getTradeSeq() const {
    return trade_seq;
}
void
OAIPublic_trade::setTradeSeq(const qint32 &trade_seq) {
...
QString
OAIPublic_trade::getTradeId() const {
    return trade_id;
}
void
OAIPublic_trade::setTradeId(const QString &trade_id) {
...
OAINumber
OAIPublic_trade::getIv() const {
    return iv;
}
void
OAIPublic_trade::setIv(const OAINumber &iv) {
    this->iv = iv;
...
OAINumber
OAIPublic_trade::getIndexPrice() const {
    return index_price;
}
void
OAIPublic_trade::setIndexPrice(const OAINumber &index_price) {
...
OAINumber
OAIPublic_trade::getAmount() const {
    return amount;
}
void
OAIPublic_trade::setAmount(const OAINumber &amount) {
    this->amount = amount;
...
QString
OAIPublic_trade::getInstrumentName() const {
    return instrument_name;
}
void
OAIPublic_trade::setInstrumentName(const QString &instrument_name) {
    this->instrument_name = instrument_name;
    this->m_instrument_name_isSet = true;
}

bool
OAIPublic_trade::isSet() const {
    ...
    do{ 
        ...
        if(iv.isSet()){ isObjectUpdated = true; break;}
...
bool
OAIPublic_trade::isValid() const {
    // only required properties are required for the object to be considered valid
    return m_direction_isValid && m_tick_direction_isValid && m_timestamp_isValid && m_price_isValid && m_trade_seq_isValid && m_trade_id_isValid && m_index_price_isValid && m_amount_isValid && m_instrument_name_isValid && true;
}
