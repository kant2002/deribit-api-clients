...
void
OAIPublic_trade::setPrice(const double &price) {
    this->price = price;
...
void
OAIPublic_trade::setIv(const double &iv) {
    this->iv = iv;
...
void
OAIPublic_trade::setIndexPrice(const double &index_price) {
...
void
OAIPublic_trade::setAmount(const double &amount) {
    this->amount = amount;
