...
OAISupportingApi::OAISupportingApi() : basePath("/api/v2"),
...
OAISupportingApi::OAISupportingApi(const QString& host, const QString& basePath) {
    this->host = host;
    this->basePath = basePath;
}

void OAISupportingApi::setBasePath(const QString& basePath){
    this->basePath = basePath;
}

void OAISupportingApi::setHost(const QString& host){
    this->host = host;
}

void OAISupportingApi::addHeaders(const QString& key, const QString& value){
