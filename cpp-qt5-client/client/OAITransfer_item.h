...
class OAITransfer_item: public OAIObject {
public:
    OAITransfer_item();
    OAITransfer_item(QString json);
    ~OAITransfer_item() override;
    ...
    QString getOtherSide() const;
    void setOtherSide(const QString &other_side);
...
private:
    ...
    QString other_side;
    bool m_other_side_isSet;
    bool m_other_side_isValid;
