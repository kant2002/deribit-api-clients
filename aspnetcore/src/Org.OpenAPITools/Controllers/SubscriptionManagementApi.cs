...
{ 
    ...
    /// </summary>
    [ApiController]
    public class SubscriptionManagementApiController : ControllerBase
    { 
        /// <summary>
        ...
        /// <response code="401">not authorised</response>
        [HttpGet]
        [Route("/api/v2/public/unsubscribe")]
        [ValidateModelState]
        [SwaggerOperation("PublicUnsubscribeGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Object), description: "ok response")]
        [SwaggerResponse(statusCode: 401, type: typeof(Object), description: "not authorised")]
        public virtual IActionResult PublicUnsubscribeGet([FromQuery][Required()]List<string> channels)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Object));
