...
{ 
    ...
    { 
        ...
        /// <response code="200">ok response</response>
        [HttpGet]
        [Route("/api/v2/public/get_footer")]
        [ValidateModelState]
        [SwaggerOperation("PublicGetFooterGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Object), description: "ok response")]
        public virtual IActionResult PublicGetFooterGet()
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Object));
        ...
        /// <response code="200">ok response</response>
        [HttpGet]
        [Route("/api/v2/public/get_option_mark_prices")]
        [ValidateModelState]
        [SwaggerOperation("PublicGetOptionMarkPricesGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Object), description: "ok response")]
        public virtual IActionResult PublicGetOptionMarkPricesGet([FromQuery][Required()]string currency)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Object));
