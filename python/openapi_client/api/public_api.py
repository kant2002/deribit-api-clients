...
class PublicApi(object):
    ...
    def public_auth_get(self, grant_type, username, password, client_id, client_secret, refresh_token, timestamp, signature, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.public_auth_get_with_http_info(grant_type, username, password, client_id, client_secret, refresh_token, timestamp, signature, **kwargs)  # noqa: E501
            return data
    ...
    def public_get_time_get(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.public_get_time_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.public_get_time_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.public_get_time_get_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def public_test_get(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.public_test_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.public_test_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.public_test_get_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def public_test_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'expected_result' in local_var_params:
            query_params.append(('expected_result', local_var_params['expected_result']))  # noqa: E501
