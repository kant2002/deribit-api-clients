...
module OpenapiClient
  class Instrument
    ...
    attr_accessor :min_trade_amount
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Instrument` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Instrument`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tick_size')
        self.tick_size = attributes[:'tick_size']
      end

      if attributes.key?(:'contract_size')
        self.contract_size = attributes[:'contract_size']
      end
      ...
      if attributes.key?(:'min_trade_amount')
        self.min_trade_amount = attributes[:'min_trade_amount']
      end
      ...
      if attributes.key?(:'settlement_period')
        self.settlement_period = attributes[:'settlement_period']
      end
    ...
    def list_invalid_properties
      ...
      if @tick_size.nil?
        invalid_properties.push('invalid value for "tick_size", tick_size cannot be nil.')
      end

      if @contract_size.nil?
        invalid_properties.push('invalid value for "contract_size", contract_size cannot be nil.')
      end
      ...
      if @min_trade_amount.nil?
        invalid_properties.push('invalid value for "min_trade_amount", min_trade_amount cannot be nil.')
      end
      ...
      if @settlement_period.nil?
        invalid_properties.push('invalid value for "settlement_period", settlement_period cannot be nil.')
      end
    ...
    def valid?
      ...
      quote_currency_validator = EnumAttributeValidator.new('String', ["USD"])
      return false unless quote_currency_validator.valid?(@quote_currency)
      return false if @kind.nil?
      kind_validator = EnumAttributeValidator.new('String', ["future", "option"])
      return false unless kind_validator.valid?(@kind)
      return false if @tick_size.nil?
      return false if @contract_size.nil?
      return false if @is_active.nil?
      option_type_validator = EnumAttributeValidator.new('String', ["call", "put"])
      return false unless option_type_validator.valid?(@option_type)
      return false if @min_trade_amount.nil?
      return false if @instrument_name.nil?
      return false if @settlement_period.nil?
      settlement_period_validator = EnumAttributeValidator.new('String', ["month", "week", "perpetual"])
      return false unless settlement_period_validator.valid?(@settlement_period)
      return false if @base_currency.nil?
      base_currency_validator = EnumAttributeValidator.new('String', ["BTC", "ETH"])
    ...
    # @param [Object] quote_currency Object to be assigned
    def quote_currency=(quote_currency)
      validator = EnumAttributeValidator.new('String', ["USD"])
      unless validator.valid?(quote_currency)
        fail ArgumentError, "invalid value for \"quote_currency\", must be one of #{validator.allowable_values}."
      end
      @quote_currency = quote_currency
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] settlement_period Object to be assigned
    def settlement_period=(settlement_period)
      validator = EnumAttributeValidator.new('String', ["month", "week", "perpetual"])
      unless validator.valid?(settlement_period)
        fail ArgumentError, "invalid value for \"settlement_period\", must be one of #{validator.allowable_values}."
      end
      @settlement_period = settlement_period
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          min_trade_amount == o.min_trade_amount &&
    ...
    def hash
      [quote_currency, kind, tick_size, contract_size, is_active, option_type, min_trade_amount, instrument_name, settlement_period, strike, base_currency, creation_timestamp, expiration_timestamp].hash
    end
