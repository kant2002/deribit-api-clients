...
module OpenapiClient
  class Withdrawal
    ...
    attr_accessor :confirmed_timestamp
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Withdrawal` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Withdrawal`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'confirmed_timestamp')
        self.confirmed_timestamp = attributes[:'confirmed_timestamp']
      end
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ["unconfirmed", "confirmed", "cancelled", "completed", "interrupted", "rejected"])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["unconfirmed", "confirmed", "cancelled", "completed", "interrupted", "rejected"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fee == o.fee &&
          confirmed_timestamp == o.confirmed_timestamp &&
          amount == o.amount &&
          priority == o.priority &&
          currency == o.currency &&
          state == o.state &&
    ...
    def hash
      [updated_timestamp, fee, confirmed_timestamp, amount, priority, currency, state, address, created_timestamp, id, transaction_id].hash
    end
