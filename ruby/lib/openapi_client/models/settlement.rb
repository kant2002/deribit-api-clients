...
module OpenapiClient
  class Settlement
    ...
    attr_accessor :session_profit_loss
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Settlement` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Settlement`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'session_profit_loss')
        self.session_profit_loss = attributes[:'session_profit_loss']
      end
      ...
      if attributes.key?(:'socialized')
        self.socialized = attributes[:'socialized']
      end

      if attributes.key?(:'session_bankrupcy')
        self.session_bankrupcy = attributes[:'session_bankrupcy']
      end
      ...
      if attributes.key?(:'session_tax')
        self.session_tax = attributes[:'session_tax']
      end

      if attributes.key?(:'session_tax_rate')
        self.session_tax_rate = attributes[:'session_tax_rate']
      end
    ...
    def list_invalid_properties
      ...
      if @session_profit_loss.nil?
        invalid_properties.push('invalid value for "session_profit_loss", session_profit_loss cannot be nil.')
      end
    ...
    def valid?
      return false if @session_profit_loss.nil?
      ...
      type_validator = EnumAttributeValidator.new('String', ["settlement", "delivery", "bankruptcy"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["settlement", "delivery", "bankruptcy"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          session_profit_loss == o.session_profit_loss &&
          mark_price == o.mark_price &&
          funding == o.funding &&
          socialized == o.socialized &&
          session_bankrupcy == o.session_bankrupcy &&
          timestamp == o.timestamp &&
          profit_loss == o.profit_loss &&
          funded == o.funded &&
          index_price == o.index_price &&
          session_tax == o.session_tax &&
          session_tax_rate == o.session_tax_rate &&
    ...
    def hash
      [session_profit_loss, mark_price, funding, socialized, session_bankrupcy, timestamp, profit_loss, funded, index_price, session_tax, session_tax_rate, instrument_name, position, type].hash
    end
