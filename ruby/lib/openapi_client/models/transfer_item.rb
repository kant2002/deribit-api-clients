  ...
  class TransferItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TransferItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TransferItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'other_side')
        self.other_side = attributes[:'other_side']
      end
    ...
    def list_invalid_properties
      ...
      if @other_side.nil?
        invalid_properties.push('invalid value for "other_side", other_side cannot be nil.')
      end
    ...
    def valid?
      ...
      direction_validator = EnumAttributeValidator.new('String', ["payment", "income"])
      return false unless direction_validator.valid?(@direction)
      return false if @amount.nil?
      return false if @other_side.nil?
      return false if @currency.nil?
      currency_validator = EnumAttributeValidator.new('String', ["BTC", "ETH"])
      return false unless currency_validator.valid?(@currency)
      return false if @state.nil?
      state_validator = EnumAttributeValidator.new('String', ["prepared", "confirmed", "cancelled", "waiting_for_admin", "rejection_reason"])
      return false unless state_validator.valid?(@state)
      return false if @created_timestamp.nil?
      return false if @type.nil?
      type_validator = EnumAttributeValidator.new('String', ["user", "subaccount"])
    ...
    def direction=(direction)
      validator = EnumAttributeValidator.new('String', ["payment", "income"])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["prepared", "confirmed", "cancelled", "waiting_for_admin", "rejection_reason"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["user", "subaccount"])
    ...
    def hash
      [updated_timestamp, direction, amount, other_side, currency, state, created_timestamp, type, id].hash
    end
