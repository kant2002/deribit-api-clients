...
module OpenapiClient
  class BookSummary
    ...
    attr_accessor :underlying_index
    ...
    attr_accessor :estimated_delivery_price
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::BookSummary` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::BookSummary`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'underlying_index')
        self.underlying_index = attributes[:'underlying_index']
      end
      ...
      if attributes.key?(:'estimated_delivery_price')
        self.estimated_delivery_price = attributes[:'estimated_delivery_price']
      end
      ...
      if attributes.key?(:'mid_price')
        self.mid_price = attributes[:'mid_price']
      end
      ...
      if attributes.key?(:'funding_8h')
        self.funding_8h = attributes[:'funding_8h']
      end
      ...
      if attributes.key?(:'current_funding')
        self.current_funding = attributes[:'current_funding']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @bid_price.nil?
        invalid_properties.push('invalid value for "bid_price", bid_price cannot be nil.')
      end

      if @open_interest.nil?
        invalid_properties.push('invalid value for "open_interest", open_interest cannot be nil.')
      end
      ...
      if @mid_price.nil?
        invalid_properties.push('invalid value for "mid_price", mid_price cannot be nil.')
      end
      ...
      if @ask_price.nil?
        invalid_properties.push('invalid value for "ask_price", ask_price cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bid_price.nil?
      return false if @open_interest.nil?
      return false if @quote_currency.nil?
      return false if @high.nil?
      return false if @last.nil?
      return false if @mid_price.nil?
      return false if @mark_price.nil?
      return false if @ask_price.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          high == o.high &&
          estimated_delivery_price == o.estimated_delivery_price &&
          last == o.last &&
          mid_price == o.mid_price &&
          interest_rate == o.interest_rate &&
          funding_8h == o.funding_8h &&
          ...
          current_funding == o.current_funding
    end
    ...
    def hash
      [underlying_index, volume, volume_usd, underlying_price, bid_price, open_interest, quote_currency, high, estimated_delivery_price, last, mid_price, interest_rate, funding_8h, mark_price, ask_price, instrument_name, low, base_currency, creation_timestamp, current_funding].hash
    end
