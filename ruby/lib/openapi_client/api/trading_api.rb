  ...
  class TradingApi
    ...
    def private_buy_get_with_http_info(instrument_name, amount, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_buy_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling TradingApi.private_buy_get"
      end
      # verify the required parameter 'amount' is set
      if @api_client.config.client_side_validation && amount.nil?
        fail ArgumentError, "Missing the required parameter 'amount' when calling TradingApi.private_buy_get"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_buy_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def private_cancel_all_by_currency_get_with_http_info(currency, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_cancel_all_by_currency_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling TradingApi.private_cancel_all_by_currency_get"
      end
      # verify enum value
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_cancel_all_by_currency_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_cancel_all_by_instrument_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_cancel_all_by_instrument_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling TradingApi.private_cancel_all_by_instrument_get"
      end
      allowable_values = ["all", "limit", "stop"]
      if @api_client.config.client_side_validation && opts[:'type'] && !allowable_values.include?(opts[:'type'])
        fail ArgumentError, "invalid value for \"type\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_cancel_all_by_instrument_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_close_position_get_with_http_info(instrument_name, type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_close_position_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling TradingApi.private_close_position_get"
      end
      # verify the required parameter 'type' is set
      if @api_client.config.client_side_validation && type.nil?
        fail ArgumentError, "Missing the required parameter 'type' when calling TradingApi.private_close_position_get"
      end
      # verify enum value
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_close_position_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_edit_get_with_http_info(order_id, amount, price, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_edit_get ...'
      end
      # verify the required parameter 'order_id' is set
      if @api_client.config.client_side_validation && order_id.nil?
        fail ArgumentError, "Missing the required parameter 'order_id' when calling TradingApi.private_edit_get"
      end
      # verify the required parameter 'amount' is set
      if @api_client.config.client_side_validation && amount.nil?
        fail ArgumentError, "Missing the required parameter 'amount' when calling TradingApi.private_edit_get"
      end
      # verify the required parameter 'price' is set
      if @api_client.config.client_side_validation && price.nil?
        fail ArgumentError, "Missing the required parameter 'price' when calling TradingApi.private_edit_get"
      end
      allowable_values = ["usd", "implv"]
      if @api_client.config.client_side_validation && opts[:'advanced'] && !allowable_values.include?(opts[:'advanced'])
        fail ArgumentError, "invalid value for \"advanced\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_edit_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_margins_get_with_http_info(instrument_name, amount, price, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_margins_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling TradingApi.private_get_margins_get"
      end
      # verify the required parameter 'amount' is set
      if @api_client.config.client_side_validation && amount.nil?
        fail ArgumentError, "Missing the required parameter 'amount' when calling TradingApi.private_get_margins_get"
      end
      # verify the required parameter 'price' is set
      if @api_client.config.client_side_validation && price.nil?
        fail ArgumentError, "Missing the required parameter 'price' when calling TradingApi.private_get_margins_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_margins_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_open_orders_by_currency_get_with_http_info(currency, opts = {})
      ...
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling TradingApi.private_get_open_orders_by_currency_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_open_orders_by_currency_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_open_orders_by_instrument_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_open_orders_by_instrument_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling TradingApi.private_get_open_orders_by_instrument_get"
      end
      allowable_values = ["all", "limit", "stop_all", "stop_limit", "stop_market"]
      if @api_client.config.client_side_validation && opts[:'type'] && !allowable_values.include?(opts[:'type'])
        fail ArgumentError, "invalid value for \"type\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_open_orders_by_instrument_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_order_history_by_currency_get_with_http_info(currency, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_order_history_by_currency_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling TradingApi.private_get_order_history_by_currency_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_order_history_by_currency_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_order_margin_by_ids_get_with_http_info(ids, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_order_margin_by_ids_get ...'
      end
      # verify the required parameter 'ids' is set
      if @api_client.config.client_side_validation && ids.nil?
        fail ArgumentError, "Missing the required parameter 'ids' when calling TradingApi.private_get_order_margin_by_ids_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_order_margin_by_ids_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_order_state_get_with_http_info(order_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_order_state_get ...'
      end
      # verify the required parameter 'order_id' is set
      if @api_client.config.client_side_validation && order_id.nil?
        fail ArgumentError, "Missing the required parameter 'order_id' when calling TradingApi.private_get_order_state_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_order_state_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_settlement_history_by_currency_get_with_http_info(currency, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_settlement_history_by_currency_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling TradingApi.private_get_settlement_history_by_currency_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_settlement_history_by_currency_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_settlement_history_by_instrument_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_settlement_history_by_instrument_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling TradingApi.private_get_settlement_history_by_instrument_get"
      end
      allowable_values = ["settlement", "delivery", "bankruptcy"]
      if @api_client.config.client_side_validation && opts[:'type'] && !allowable_values.include?(opts[:'type'])
        fail ArgumentError, "invalid value for \"type\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_settlement_history_by_instrument_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_user_trades_by_currency_and_time_get_with_http_info(currency, start_timestamp, end_timestamp, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_user_trades_by_currency_and_time_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling TradingApi.private_get_user_trades_by_currency_and_time_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      if @api_client.config.client_side_validation && start_timestamp.nil?
        fail ArgumentError, "Missing the required parameter 'start_timestamp' when calling TradingApi.private_get_user_trades_by_currency_and_time_get"
      end
      # verify the required parameter 'end_timestamp' is set
      if @api_client.config.client_side_validation && end_timestamp.nil?
        fail ArgumentError, "Missing the required parameter 'end_timestamp' when calling TradingApi.private_get_user_trades_by_currency_and_time_get"
      end
      allowable_values = ["future", "option"]
      if @api_client.config.client_side_validation && opts[:'kind'] && !allowable_values.include?(opts[:'kind'])
        fail ArgumentError, "invalid value for \"kind\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_user_trades_by_currency_and_time_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_user_trades_by_currency_get_with_http_info(currency, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_user_trades_by_currency_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling TradingApi.private_get_user_trades_by_currency_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_user_trades_by_currency_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_user_trades_by_instrument_and_time_get_with_http_info(instrument_name, start_timestamp, end_timestamp, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_user_trades_by_instrument_and_time_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling TradingApi.private_get_user_trades_by_instrument_and_time_get"
      end
      # verify the required parameter 'start_timestamp' is set
      if @api_client.config.client_side_validation && start_timestamp.nil?
        fail ArgumentError, "Missing the required parameter 'start_timestamp' when calling TradingApi.private_get_user_trades_by_instrument_and_time_get"
      end
      # verify the required parameter 'end_timestamp' is set
      if @api_client.config.client_side_validation && end_timestamp.nil?
        fail ArgumentError, "Missing the required parameter 'end_timestamp' when calling TradingApi.private_get_user_trades_by_instrument_and_time_get"
      end
      allowable_values = ["asc", "desc", "default"]
      if @api_client.config.client_side_validation && opts[:'sorting'] && !allowable_values.include?(opts[:'sorting'])
        fail ArgumentError, "invalid value for \"sorting\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_user_trades_by_instrument_and_time_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_user_trades_by_instrument_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_user_trades_by_instrument_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling TradingApi.private_get_user_trades_by_instrument_get"
      end
      allowable_values = ["asc", "desc", "default"]
      if @api_client.config.client_side_validation && opts[:'sorting'] && !allowable_values.include?(opts[:'sorting'])
        fail ArgumentError, "invalid value for \"sorting\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_user_trades_by_instrument_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_get_user_trades_by_order_get_with_http_info(order_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_get_user_trades_by_order_get ...'
      end
      # verify the required parameter 'order_id' is set
      if @api_client.config.client_side_validation && order_id.nil?
        fail ArgumentError, "Missing the required parameter 'order_id' when calling TradingApi.private_get_user_trades_by_order_get"
      end
      allowable_values = ["asc", "desc", "default"]
      if @api_client.config.client_side_validation && opts[:'sorting'] && !allowable_values.include?(opts[:'sorting'])
        fail ArgumentError, "invalid value for \"sorting\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_get_user_trades_by_order_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def private_sell_get_with_http_info(instrument_name, amount, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TradingApi.private_sell_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling TradingApi.private_sell_get"
      end
      # verify the required parameter 'amount' is set
      if @api_client.config.client_side_validation && amount.nil?
        fail ArgumentError, "Missing the required parameter 'amount' when calling TradingApi.private_sell_get"
      end
      allowable_values = ["limit", "stop_limit", "market", "stop_market"]
      if @api_client.config.client_side_validation && opts[:'type'] && !allowable_values.include?(opts[:'type'])
        fail ArgumentError, "invalid value for \"type\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TradingApi#private_sell_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
