  ...
  class MarketDataApi
    ...
    def public_get_book_summary_by_currency_get_with_http_info(currency, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_book_summary_by_currency_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling MarketDataApi.public_get_book_summary_by_currency_get"
      end
      # verify enum value
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_book_summary_by_currency_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def public_get_book_summary_by_instrument_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_book_summary_by_instrument_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling MarketDataApi.public_get_book_summary_by_instrument_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_book_summary_by_instrument_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_contract_size_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_contract_size_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling MarketDataApi.public_get_contract_size_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_contract_size_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_currencies_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_currencies_get ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_currencies_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_funding_chart_data_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_funding_chart_data_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling MarketDataApi.public_get_funding_chart_data_get"
      end
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_funding_chart_data_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_historical_volatility_get_with_http_info(currency, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_historical_volatility_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling MarketDataApi.public_get_historical_volatility_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_historical_volatility_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_index_get_with_http_info(currency, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_index_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling MarketDataApi.public_get_index_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_index_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_instruments_get_with_http_info(currency, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_instruments_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling MarketDataApi.public_get_instruments_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_instruments_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_last_settlements_by_currency_get_with_http_info(currency, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_last_settlements_by_currency_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling MarketDataApi.public_get_last_settlements_by_currency_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_last_settlements_by_currency_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_last_settlements_by_instrument_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_last_settlements_by_instrument_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling MarketDataApi.public_get_last_settlements_by_instrument_get"
      end
      allowable_values = ["settlement", "delivery", "bankruptcy"]
      if @api_client.config.client_side_validation && opts[:'type'] && !allowable_values.include?(opts[:'type'])
        fail ArgumentError, "invalid value for \"type\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_last_settlements_by_instrument_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_last_trades_by_currency_and_time_get_with_http_info(currency, start_timestamp, end_timestamp, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_last_trades_by_currency_and_time_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling MarketDataApi.public_get_last_trades_by_currency_and_time_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      if @api_client.config.client_side_validation && start_timestamp.nil?
        fail ArgumentError, "Missing the required parameter 'start_timestamp' when calling MarketDataApi.public_get_last_trades_by_currency_and_time_get"
      end
      # verify the required parameter 'end_timestamp' is set
      if @api_client.config.client_side_validation && end_timestamp.nil?
        fail ArgumentError, "Missing the required parameter 'end_timestamp' when calling MarketDataApi.public_get_last_trades_by_currency_and_time_get"
      end
      allowable_values = ["future", "option"]
      if @api_client.config.client_side_validation && opts[:'kind'] && !allowable_values.include?(opts[:'kind'])
        fail ArgumentError, "invalid value for \"kind\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_last_trades_by_currency_and_time_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_last_trades_by_currency_get_with_http_info(currency, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_last_trades_by_currency_get ...'
      end
      # verify the required parameter 'currency' is set
      if @api_client.config.client_side_validation && currency.nil?
        fail ArgumentError, "Missing the required parameter 'currency' when calling MarketDataApi.public_get_last_trades_by_currency_get"
      end
      # verify enum value
      allowable_values = ["BTC", "ETH"]
      if @api_client.config.client_side_validation && !allowable_values.include?(currency)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_last_trades_by_currency_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_last_trades_by_instrument_and_time_get_with_http_info(instrument_name, start_timestamp, end_timestamp, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_last_trades_by_instrument_and_time_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling MarketDataApi.public_get_last_trades_by_instrument_and_time_get"
      end
      # verify the required parameter 'start_timestamp' is set
      if @api_client.config.client_side_validation && start_timestamp.nil?
        fail ArgumentError, "Missing the required parameter 'start_timestamp' when calling MarketDataApi.public_get_last_trades_by_instrument_and_time_get"
      end
      # verify the required parameter 'end_timestamp' is set
      if @api_client.config.client_side_validation && end_timestamp.nil?
        fail ArgumentError, "Missing the required parameter 'end_timestamp' when calling MarketDataApi.public_get_last_trades_by_instrument_and_time_get"
      end
      allowable_values = ["asc", "desc", "default"]
      if @api_client.config.client_side_validation && opts[:'sorting'] && !allowable_values.include?(opts[:'sorting'])
        fail ArgumentError, "invalid value for \"sorting\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_last_trades_by_instrument_and_time_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_last_trades_by_instrument_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_last_trades_by_instrument_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling MarketDataApi.public_get_last_trades_by_instrument_get"
      end
      allowable_values = ["asc", "desc", "default"]
      if @api_client.config.client_side_validation && opts[:'sorting'] && !allowable_values.include?(opts[:'sorting'])
        fail ArgumentError, "invalid value for \"sorting\", must be one of #{allowable_values}"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_last_trades_by_instrument_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_order_book_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_order_book_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling MarketDataApi.public_get_order_book_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_order_book_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_trade_volumes_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_trade_volumes_get ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_trade_volumes_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_get_tradingview_chart_data_get_with_http_info(instrument_name, start_timestamp, end_timestamp, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_get_tradingview_chart_data_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling MarketDataApi.public_get_tradingview_chart_data_get"
      end
      # verify the required parameter 'start_timestamp' is set
      if @api_client.config.client_side_validation && start_timestamp.nil?
        fail ArgumentError, "Missing the required parameter 'start_timestamp' when calling MarketDataApi.public_get_tradingview_chart_data_get"
      end
      # verify the required parameter 'end_timestamp' is set
      if @api_client.config.client_side_validation && end_timestamp.nil?
        fail ArgumentError, "Missing the required parameter 'end_timestamp' when calling MarketDataApi.public_get_tradingview_chart_data_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_get_tradingview_chart_data_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_ticker_get_with_http_info(instrument_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MarketDataApi.public_ticker_get ...'
      end
      # verify the required parameter 'instrument_name' is set
      if @api_client.config.client_side_validation && instrument_name.nil?
        fail ArgumentError, "Missing the required parameter 'instrument_name' when calling MarketDataApi.public_ticker_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MarketDataApi#public_ticker_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
