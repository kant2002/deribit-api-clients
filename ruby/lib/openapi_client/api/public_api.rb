...
module OpenapiClient
  class PublicApi
    ...
    def public_disable_heartbeat_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PublicApi.public_disable_heartbeat_get ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PublicApi#public_disable_heartbeat_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_hello_get_with_http_info(client_name, client_version, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PublicApi.public_hello_get ...'
      end
      # verify the required parameter 'client_name' is set
      if @api_client.config.client_side_validation && client_name.nil?
        fail ArgumentError, "Missing the required parameter 'client_name' when calling PublicApi.public_hello_get"
      end
      # verify the required parameter 'client_version' is set
      if @api_client.config.client_side_validation && client_version.nil?
        fail ArgumentError, "Missing the required parameter 'client_version' when calling PublicApi.public_hello_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PublicApi#public_hello_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_set_heartbeat_get_with_http_info(interval, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PublicApi.public_set_heartbeat_get ...'
      end
      # verify the required parameter 'interval' is set
      if @api_client.config.client_side_validation && interval.nil?
        fail ArgumentError, "Missing the required parameter 'interval' when calling PublicApi.public_set_heartbeat_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PublicApi#public_set_heartbeat_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_subscribe_get_with_http_info(channels, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PublicApi.public_subscribe_get ...'
      end
      # verify the required parameter 'channels' is set
      if @api_client.config.client_side_validation && channels.nil?
        fail ArgumentError, "Missing the required parameter 'channels' when calling PublicApi.public_subscribe_get"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PublicApi#public_subscribe_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
