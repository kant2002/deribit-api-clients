...
# Unit tests for OpenapiClient::InternalApi
...
describe 'InternalApi' do
  ...
  describe 'test an instance of InternalApi' do
    it 'should create an instance of InternalApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::InternalApi)
    end
  end
  ...
  # unit tests for public_get_footer_get
  # Get information to be displayed in the footer of the website.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_footer_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_option_mark_prices_get
  # Retrives market prices and its implied volatility of options instruments
  # @param currency The currency symbol
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_option_mark_prices_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
