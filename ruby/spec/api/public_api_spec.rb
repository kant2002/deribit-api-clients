...
describe 'PublicApi' do
  ...
  # unit tests for public_auth_get
  # Authenticate
  ...
  # @param grant_type Method of authentication
  # @param username Required for grant type &#x60;password&#x60;
  # @param password Required for grant type &#x60;password&#x60;
  # @param client_id Required for grant type &#x60;client_credentials&#x60; and &#x60;client_signature&#x60;
  # @param client_secret Required for grant type &#x60;client_credentials&#x60;
  # @param refresh_token Required for grant type &#x60;refresh_token&#x60;
  ...
  # @return [Object]
  describe 'public_auth_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_disable_heartbeat_get
  # Stop sending heartbeat messages.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_disable_heartbeat_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_announcements_get
  # Retrieves announcements from the last 30 days.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_announcements_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_book_summary_by_currency_get
  ...
  # @return [Object]
  describe 'public_get_book_summary_by_currency_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_book_summary_by_instrument_get
  # Retrieves the summary information such as open interest, 24h volume, etc. for a specific instrument.
  # @param instrument_name Instrument name
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_book_summary_by_instrument_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_contract_size_get
  # Retrieves contract size of provided instrument.
  # @param instrument_name Instrument name
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_contract_size_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_currencies_get
  # Retrieves all cryptocurrencies supported by the API.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_currencies_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_funding_chart_data_get
  # Retrieve the latest user trades that have occurred for PERPETUAL instruments in a specific currency symbol and within given time range.
  # @param instrument_name Instrument name
  # @param [Hash] opts the optional parameters
  # @option opts [String] :length Specifies time period. &#x60;8h&#x60; - 8 hours, &#x60;24h&#x60; - 24 hours
  # @return [Object]
  describe 'public_get_funding_chart_data_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_historical_volatility_get
  # Provides information about historical volatility for given cryptocurrency.
  # @param currency The currency symbol
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_historical_volatility_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_index_get
  # Retrieves the current index price for the instruments, for the selected currency.
  # @param currency The currency symbol
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_index_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_instruments_get
  ...
  # @return [Object]
  describe 'public_get_instruments_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_last_settlements_by_currency_get
  ...
  # @return [Object]
  describe 'public_get_last_settlements_by_currency_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_last_settlements_by_instrument_get
  ...
  # @option opts [Integer] :search_start_timestamp The latest timestamp to return result for
  # @return [Object]
  describe 'public_get_last_settlements_by_instrument_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_last_trades_by_currency_and_time_get
  ...
  # @return [Object]
  describe 'public_get_last_trades_by_currency_and_time_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_last_trades_by_currency_get
  ...
  # @option opts [String] :sorting Direction of results sorting (&#x60;default&#x60; value means no sorting, results will be returned in order in which they left the database)
  # @return [Object]
  describe 'public_get_last_trades_by_currency_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_last_trades_by_instrument_and_time_get
  ...
  # @option opts [String] :sorting Direction of results sorting (&#x60;default&#x60; value means no sorting, results will be returned in order in which they left the database)
  # @return [Object]
  describe 'public_get_last_trades_by_instrument_and_time_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_last_trades_by_instrument_get
  ...
  # @option opts [String] :sorting Direction of results sorting (&#x60;default&#x60; value means no sorting, results will be returned in order in which they left the database)
  # @return [Object]
  describe 'public_get_last_trades_by_instrument_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_order_book_get
  # Retrieves the order book, along with other market values for a given instrument.
  # @param instrument_name The instrument name for which to retrieve the order book, see [&#x60;getinstruments&#x60;](#getinstruments) to obtain instrument names.
  # @param [Hash] opts the optional parameters
  # @option opts [Float] :depth The number of entries to return for bids and asks.
  # @return [Object]
  describe 'public_get_order_book_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_time_get
  # Retrieves the current time (in milliseconds). This API endpoint can be used to check the clock skew between your software and Deribit&#39;s systems.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_time_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_trade_volumes_get
  # Retrieves aggregated 24h trade volumes for different instrument types and currencies.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_trade_volumes_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_get_tradingview_chart_data_get
  ...
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_get_tradingview_chart_data_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for public_set_heartbeat_get
  ...
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_set_heartbeat_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_subscribe_get
  # Subscribe to one or more channels.
  # Subscribe to one or more channels.  This is the same method as [/private/subscribe](#private_subscribe), but it can only be used for &#39;public&#39; channels. 
  # @param channels A list of channels to subscribe to.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_subscribe_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # @return [Object]
  describe 'public_test_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_ticker_get
  # Get ticker for an instrument.
  # @param instrument_name Instrument name
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_ticker_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for public_validate_field_get
  # Method used to introduce the client software connected to Deribit platform over websocket. Provided data may have an impact on the maintained connection and will be collected for internal statistical purposes. In response, Deribit will also introduce itself.
  ...
  # @return [Object]
  describe 'public_validate_field_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
