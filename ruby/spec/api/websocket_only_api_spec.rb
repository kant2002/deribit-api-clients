...
# Unit tests for OpenapiClient::WebsocketOnlyApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WebsocketOnlyApi' do
  before do
  ...
  describe 'test an instance of WebsocketOnlyApi' do
    it 'should create an instance of WebsocketOnlyApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::WebsocketOnlyApi)
    end
  end
  ...
  # unit tests for public_unsubscribe_get
  # Unsubscribe from one or more channels.
  # @param channels A list of channels to unsubscribe from.
  # @param [Hash] opts the optional parameters
  # @return [Object]
  describe 'public_unsubscribe_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
