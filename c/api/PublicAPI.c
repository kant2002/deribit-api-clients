...
//
object_t*
PublicAPI_publicDisableHeartbeatGet(apiClient_t *apiClient)
{
...
//
object_t*
PublicAPI_publicHelloGet(apiClient_t *apiClient ,char * client_name ,char * client_version)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
object_t*
PublicAPI_publicSetHeartbeatGet(apiClient_t *apiClient ,double interval)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
object_t*
PublicAPI_publicSubscribeGet(apiClient_t *apiClient ,list_t * channels)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
