...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class PublicApi : IPublicApi
    {
        ...
        public ApiResponse< Object > PublicHelloGetWithHttpInfo (string clientName, string clientVersion)
        {
            ...
            if (clientName == null)
                throw new ApiException(400, "Missing required parameter 'clientName' when calling PublicApi->PublicHelloGet");
            // verify the required parameter 'clientVersion' is set
            if (clientVersion == null)
                throw new ApiException(400, "Missing required parameter 'clientVersion' when calling PublicApi->PublicHelloGet");
        ...
        public ApiResponse< Object > PublicSetHeartbeatGetWithHttpInfo (decimal? interval)
        {
            ...
            if (interval == null)
                throw new ApiException(400, "Missing required parameter 'interval' when calling PublicApi->PublicSetHeartbeatGet");
        ...
        public ApiResponse< Object > PublicSubscribeGetWithHttpInfo (List<string> channels)
        {
            ...
            if (channels == null)
                throw new ApiException(400, "Missing required parameter 'channels' when calling PublicApi->PublicSubscribeGet");
