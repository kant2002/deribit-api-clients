...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface ISupportingApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SupportingApi : ISupportingApi
    {
        private Org.OpenAPITools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SupportingApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SupportingApi(String basePath)
        {
        ...
        /// <returns></returns>
        public SupportingApi(Org.OpenAPITools.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< Object > PublicHelloGetWithHttpInfo (string clientName, string clientVersion)
        {
            ...
            if (clientName == null)
                throw new ApiException(400, "Missing required parameter 'clientName' when calling SupportingApi->PublicHelloGet");
            // verify the required parameter 'clientVersion' is set
            if (clientVersion == null)
                throw new ApiException(400, "Missing required parameter 'clientVersion' when calling SupportingApi->PublicHelloGet");
