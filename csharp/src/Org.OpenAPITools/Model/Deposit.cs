...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Deposit :  IEquatable<Deposit>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Deposit state, allowed values : &#x60;pending&#x60;, &#x60;completed&#x60;, &#x60;rejected&#x60;, &#x60;replaced&#x60;</value>
        ...
        /// <param name="state">Deposit state, allowed values : &#x60;pending&#x60;, &#x60;completed&#x60;, &#x60;rejected&#x60;, &#x60;replaced&#x60; (required).</param>
        /// <param name="receivedTimestamp">The timestamp (seconds since the Unix epoch, with millisecond precision) (required).</param>
        ...
        public Deposit(int? updatedTimestamp = default(int?), StateEnum state = default(StateEnum), int? receivedTimestamp = default(int?), CurrencyEnum currency = default(CurrencyEnum), string address = default(string), decimal? amount = default(decimal?), string transactionId = default(string))
        {
            // to ensure "updatedTimestamp" is required (not null)
            if (updatedTimestamp == null)
            {
                throw new InvalidDataException("updatedTimestamp is a required property for Deposit and cannot be null");
            }
            else
            {
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for Deposit and cannot be null");
            }
            else
            {
                this.State = state;
            ...
            {
                throw new InvalidDataException("receivedTimestamp is a required property for Deposit and cannot be null");
            }
            else
            {
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for Deposit and cannot be null");
            }
            else
            {
            ...
            if (address == null)
            {
                throw new InvalidDataException("address is a required property for Deposit and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for Deposit and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            {
                throw new InvalidDataException("transactionId is a required property for Deposit and cannot be null");
            }
            else
            {
