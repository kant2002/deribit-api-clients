...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddressBookItem :  IEquatable<AddressBookItem>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AddressBookItem);
        }

        /// <summary>
        /// Returns true if AddressBookItem instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressBookItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressBookItem input)
        {
            if (input == null)
                return false;
