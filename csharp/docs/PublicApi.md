...
namespace Example
{
    public class PublicDisableHeartbeatGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling PublicApi.PublicDisableHeartbeatGet: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class PublicHelloGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling PublicApi.PublicHelloGet: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class PublicSetHeartbeatGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling PublicApi.PublicSetHeartbeatGet: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class PublicSubscribeGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling PublicApi.PublicSubscribeGet: " + e.Message );
            }
        }
    }
}
