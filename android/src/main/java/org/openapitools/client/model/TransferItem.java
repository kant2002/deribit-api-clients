...
public class TransferItem {
  ...
  public enum StateEnum {
     prepared,  confirmed,  cancelled,  waiting_for_admin,  rejection_reason, 
  };
   ...
   **/
  @ApiModelProperty(required = true, value = "For transfer from/to subaccount returns this subaccount name, for transfer to other account returns address, for transfer from other account returns that accounts username.")
   ...
   * Id of transfer
   **/
  @ApiModelProperty(required = true, value = "Id of transfer")
  ...
  public boolean equals(Object o) {
    ...
    return (this.updatedTimestamp == null ? transferItem.updatedTimestamp == null : this.updatedTimestamp.equals(transferItem.updatedTimestamp)) &&
        (this.direction == null ? transferItem.direction == null : this.direction.equals(transferItem.direction)) &&
        (this.amount == null ? transferItem.amount == null : this.amount.equals(transferItem.amount)) &&
        (this.otherSide == null ? transferItem.otherSide == null : this.otherSide.equals(transferItem.otherSide)) &&
        (this.currency == null ? transferItem.currency == null : this.currency.equals(transferItem.currency)) &&
        (this.state == null ? transferItem.state == null : this.state.equals(transferItem.state)) &&
        (this.createdTimestamp == null ? transferItem.createdTimestamp == null : this.createdTimestamp.equals(transferItem.createdTimestamp)) &&
        (this.type == null ? transferItem.type == null : this.type.equals(transferItem.type)) &&
        (this.id == null ? transferItem.id == null : this.id.equals(transferItem.id));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.otherSide == null ? 0: this.otherSide.hashCode());
