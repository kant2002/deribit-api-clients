...
public class PublicTrade {
  ...
  public boolean equals(Object o) {
    ...
    return (this.direction == null ? publicTrade.direction == null : this.direction.equals(publicTrade.direction)) &&
        (this.tickDirection == null ? publicTrade.tickDirection == null : this.tickDirection.equals(publicTrade.tickDirection)) &&
        (this.timestamp == null ? publicTrade.timestamp == null : this.timestamp.equals(publicTrade.timestamp)) &&
        (this.price == null ? publicTrade.price == null : this.price.equals(publicTrade.price)) &&
        (this.tradeSeq == null ? publicTrade.tradeSeq == null : this.tradeSeq.equals(publicTrade.tradeSeq)) &&
        (this.tradeId == null ? publicTrade.tradeId == null : this.tradeId.equals(publicTrade.tradeId)) &&
        (this.iv == null ? publicTrade.iv == null : this.iv.equals(publicTrade.iv)) &&
        (this.indexPrice == null ? publicTrade.indexPrice == null : this.indexPrice.equals(publicTrade.indexPrice)) &&
        (this.amount == null ? publicTrade.amount == null : this.amount.equals(publicTrade.amount)) &&
        (this.instrumentName == null ? publicTrade.instrumentName == null : this.instrumentName.equals(publicTrade.instrumentName));
  }
