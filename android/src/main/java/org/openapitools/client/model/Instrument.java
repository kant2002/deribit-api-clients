...
public class Instrument {
  ...
  private QuoteCurrencyEnum quoteCurrency = null;
  ...
  private Integer contractSize = null;
  ...
  private BigDecimal minTradeAmount = null;
  @SerializedName("instrument_name")
  private String instrumentName = null;
  public enum SettlementPeriodEnum {
     month,  week,  perpetual, 
  };
  @SerializedName("settlement_period")
  private SettlementPeriodEnum settlementPeriod = null;
  ...
  private BaseCurrencyEnum baseCurrency = null;
  @SerializedName("creation_timestamp")
  private Integer creationTimestamp = null;
  @SerializedName("expiration_timestamp")
  private Integer expirationTimestamp = null;
   ...
   **/
  @ApiModelProperty(required = true, value = "specifies minimal price change and, as follows, the number of decimal places for instrument prices")
   ...
   **/
  @ApiModelProperty(required = true, value = "Contract size for instrument")
   ...
   **/
  @ApiModelProperty(required = true, value = "Minimum amount for trading. For perpetual and futures - in USD units, for options it is amount of corresponding cryptocurrency contracts, e.g., BTC or ETH.")
   ...
   **/
  @ApiModelProperty(required = true, value = "The time when the instrument was first created (milliseconds)")
  ...
  public boolean equals(Object o) {
    ...
    return (this.quoteCurrency == null ? instrument.quoteCurrency == null : this.quoteCurrency.equals(instrument.quoteCurrency)) &&
        (this.kind == null ? instrument.kind == null : this.kind.equals(instrument.kind)) &&
        (this.tickSize == null ? instrument.tickSize == null : this.tickSize.equals(instrument.tickSize)) &&
        (this.contractSize == null ? instrument.contractSize == null : this.contractSize.equals(instrument.contractSize)) &&
        (this.isActive == null ? instrument.isActive == null : this.isActive.equals(instrument.isActive)) &&
        (this.optionType == null ? instrument.optionType == null : this.optionType.equals(instrument.optionType)) &&
        (this.minTradeAmount == null ? instrument.minTradeAmount == null : this.minTradeAmount.equals(instrument.minTradeAmount)) &&
        (this.instrumentName == null ? instrument.instrumentName == null : this.instrumentName.equals(instrument.instrumentName)) &&
        (this.settlementPeriod == null ? instrument.settlementPeriod == null : this.settlementPeriod.equals(instrument.settlementPeriod)) &&
        (this.strike == null ? instrument.strike == null : this.strike.equals(instrument.strike)) &&
        (this.baseCurrency == null ? instrument.baseCurrency == null : this.baseCurrency.equals(instrument.baseCurrency)) &&
        (this.creationTimestamp == null ? instrument.creationTimestamp == null : this.creationTimestamp.equals(instrument.creationTimestamp)) &&
        (this.expirationTimestamp == null ? instrument.expirationTimestamp == null : this.expirationTimestamp.equals(instrument.expirationTimestamp));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.contractSize == null ? 0: this.contractSize.hashCode());
    ...
    result = 31 * result + (this.minTradeAmount == null ? 0: this.minTradeAmount.hashCode());
    result = 31 * result + (this.instrumentName == null ? 0: this.instrumentName.hashCode());
    result = 31 * result + (this.settlementPeriod == null ? 0: this.settlementPeriod.hashCode());
    ...
    result = 31 * result + (this.expirationTimestamp == null ? 0: this.expirationTimestamp.hashCode());
    return result;
  }
