...
export enum SupportingApiApiKeys {
}

export class SupportingApi {
    ...
    public setApiKey(key: SupportingApiApiKeys, value: string) {
        (this.authentications as any)[SupportingApiApiKeys[key]].apiKey = value;
    }
