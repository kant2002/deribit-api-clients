...
export class PublicTrade {
    ...
    */
    'direction': PublicTrade.DirectionEnum;
    /**
    * Direction of the \"tick\" (`0` = Plus Tick, `1` = Zero-Plus Tick, `2` = Minus Tick, `3` = Zero-Minus Tick).
    */
    'tickDirection': PublicTrade.TickDirectionEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "direction",
            "baseName": "direction",
            "type": "PublicTrade.DirectionEnum"
        },
        {
            "name": "tickDirection",
            "baseName": "tick_direction",
            "type": "PublicTrade.TickDirectionEnum"
        },
        {
            "name": "timestamp",
            "baseName": "timestamp",
    ...
    static getAttributeTypeMap() {
        return PublicTrade.attributeTypeMap;
    }
}

export namespace PublicTrade {
