...
export class Order {
    ...
    */
    'originalOrderType'?: Order.OriginalOrderTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "baseName": "original_order_type",
            "type": "Order.OriginalOrderTypeEnum"
        },
        {
            "name": "maxShow",
            "baseName": "max_show",
...
export namespace Order {
    ...
    export enum TimeInForceEnum {
        GoodTilCancelled = <any> 'good_til_cancelled',
    ...
    export enum OrderTypeEnum {
        Market = <any> 'market',
        Limit = <any> 'limit',
        StopMarket = <any> 'stop_market',
        StopLimit = <any> 'stop_limit'
    }
    export enum OriginalOrderTypeEnum {
        Market = <any> 'market'
    }
    export enum TriggerEnum {
        IndexPrice = <any> 'index_price',
        MarkPrice = <any> 'mark_price',
        LastPrice = <any> 'last_price'
    }
}
