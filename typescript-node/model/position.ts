...
export class Position {
    ...
    */
    'direction': Position.DirectionEnum;
    /**
    ...
    */
    'floatingProfitLossUsd'?: number;
    /**
    * Open orders margin
    */
    'openOrdersMargin': number;
    /**
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "direction",
            "baseName": "direction",
            "type": "Position.DirectionEnum"
        },
        {
            "name": "averagePriceUsd",
            "baseName": "average_price_usd",
            "type": "number"
        },
        {
        ...
        },
        {
            ...
            "baseName": "floating_profit_loss",
            "type": "number"
        },
        {
            "name": "floatingProfitLossUsd",
            "baseName": "floating_profit_loss_usd",
            "type": "number"
        },
        {
            "name": "openOrdersMargin",
            "baseName": "open_orders_margin",
            "type": "number"
        },
        {
            "name": "totalProfitLoss",
            "baseName": "total_profit_loss",
            "type": "number"
        },
        {
            "name": "realizedProfitLoss",
            "baseName": "realized_profit_loss",
            "type": "number"
        },
        {
            "name": "delta",
