...
class InternalApi(basePath: kotlin.String = "https://www.deribit.com/api/v2") : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun publicGetFooterGet() : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun publicGetOptionMarkPricesGet(currency: kotlin.String) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
