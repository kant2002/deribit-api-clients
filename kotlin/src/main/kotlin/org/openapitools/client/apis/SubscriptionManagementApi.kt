...
class SubscriptionManagementApi(basePath: kotlin.String = "https://www.deribit.com/api/v2") : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun publicUnsubscribeGet(channels: kotlin.Array<kotlin.String>) : kotlin.Any {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf("channels" to toMultiValue(channels.toList(), "multi"))
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
