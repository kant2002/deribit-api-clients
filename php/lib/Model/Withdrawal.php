 ...
 * @link     https://openapi-generator.tech
 */
class Withdrawal implements ModelInterface, ArrayAccess
{
     ...
     * Sets fee
     *
     * @param float|null $fee Fee in currency
     *
     * @return $this
     */
     ...
     *
     * @param int|null $confirmed_timestamp The timestamp (seconds since the Unix epoch, with millisecond precision) of withdrawal confirmation, `null` when not confirmed
     *
     * @return $this
     */
     ...
     * Sets priority
     *
     * @param float|null $priority Id of priority level
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param string $state Withdrawal state, allowed values : `unconfirmed`, `confirmed`, `cancelled`, `completed`, `interrupted`, `rejected`
     *
     * @return $this
     */
     ...
     * Sets address
     *
     * @param string $address Address in proper format for currency
     *
     * @return $this
     */
     ...
     *
     * @param int|null $created_timestamp The timestamp (seconds since the Unix epoch, with millisecond precision)
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param int|null $id Withdrawal id in Deribit system
     *
     * @return $this
     */
     ...
     * Sets transaction_id
     *
     * @param string $transaction_id Transaction id in proper format for currency, `null` if id is not available
     *
     * @return $this
     */
