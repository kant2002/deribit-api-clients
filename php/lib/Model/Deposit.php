...
class Deposit implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['received_timestamp'] === null) {
            $invalidProperties[] = "'received_timestamp' can't be null";
        }
     ...
     * Sets state
     *
     * @param string $state Deposit state, allowed values : `pending`, `completed`, `rejected`, `replaced`
     *
     * @return $this
     */
     ...
     *
     * @param int $received_timestamp The timestamp (seconds since the Unix epoch, with millisecond precision)
     *
     * @return $this
     */
