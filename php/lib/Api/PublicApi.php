...
class PublicApi
{
    ...
    /**
     * Operation publicAuthGet
     *
     * Authenticate
     *
     * @param  string $grant_type Method of authentication (required)
     * @param  string $username Required for grant type &#x60;password&#x60; (required)
     * @param  string $password Required for grant type &#x60;password&#x60; (required)
     * @param  string $client_id Required for grant type &#x60;client_credentials&#x60; and &#x60;client_signature&#x60; (required)
     * @param  string $client_secret Required for grant type &#x60;client_credentials&#x60; (required)
     * @param  string $refresh_token Required for grant type &#x60;refresh_token&#x60; (required)
     * @param  string $timestamp Required for grant type &#x60;client_signature&#x60;, provides time when request has been generated (required)
     * @param  string $signature Required for grant type &#x60;client_signature&#x60;; it&#39;s a cryptographic signature calculated over provided fields using user **secret key**. The signature should be calculated as an HMAC (Hash-based Message Authentication Code) with &#x60;SHA256&#x60; hash algorithm (required)
     * @param  string $nonce Optional for grant type &#x60;client_signature&#x60;; delivers user generated initialization vector for the server token (optional)
     * @param  string $state Will be passed back in the response (optional)
     * @param  string $scope Describes type of the access for assigned token, possible values: &#x60;connection&#x60;, &#x60;session&#x60;, &#x60;session:name&#x60;, &#x60;trade:[read, read_write, none]&#x60;, &#x60;wallet:[read, read_write, none]&#x60;, &#x60;account:[read, read_write, none]&#x60;, &#x60;expires:NUMBER&#x60; (token will expire after &#x60;NUMBER&#x60; of seconds).&lt;/BR&gt;&lt;/BR&gt; **NOTICE:** Depending on choosing an authentication method (&#x60;&#x60;&#x60;grant type&#x60;&#x60;&#x60;) some scopes could be narrowed by the server. e.g. when &#x60;&#x60;&#x60;grant_type &#x3D; client_credentials&#x60;&#x60;&#x60; and &#x60;&#x60;&#x60;scope &#x3D; wallet:read_write&#x60;&#x60;&#x60; it&#39;s modified by the server as &#x60;&#x60;&#x60;scope &#x3D; wallet:read&#x60;&#x60;&#x60; (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|object
     */
    public function publicAuthGet($grant_type, $username, $password, $client_id, $client_secret, $refresh_token, $timestamp, $signature, $nonce = null, $state = null, $scope = null)
    {
        list($response) = $this->publicAuthGetWithHttpInfo($grant_type, $username, $password, $client_id, $client_secret, $refresh_token, $timestamp, $signature, $nonce, $state, $scope);
        return $response;
    }

    /**
     * Operation publicAuthGetWithHttpInfo
     *
     * Authenticate
     *
     * @param  string $grant_type Method of authentication (required)
     ...
     */
    public function publicAuthGetWithHttpInfo($grant_type, $username, $password, $client_id, $client_secret, $refresh_token, $timestamp, $signature, $nonce = null, $state = null, $scope = null)
    {
        $request = $this->publicAuthGetRequest($grant_type, $username, $password, $client_id, $client_secret, $refresh_token, $timestamp, $signature, $nonce, $state, $scope);
     ...
     */
    public function publicAuthGetAsync($grant_type, $username, $password, $client_id, $client_secret, $refresh_token, $timestamp, $signature, $nonce = null, $state = null, $scope = null)
    {
        return $this->publicAuthGetAsyncWithHttpInfo($grant_type, $username, $password, $client_id, $client_secret, $refresh_token, $timestamp, $signature, $nonce, $state, $scope)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation publicAuthGetAsyncWithHttpInfo
     *
     * Authenticate
     *
     * @param  string $grant_type Method of authentication (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicAuthGetAsyncWithHttpInfo($grant_type, $username, $password, $client_id, $client_secret, $refresh_token, $timestamp, $signature, $nonce = null, $state = null, $scope = null)
    {
        $returnType = 'object';
        $request = $this->publicAuthGetRequest($grant_type, $username, $password, $client_id, $client_secret, $refresh_token, $timestamp, $signature, $nonce, $state, $scope);
    ...
    /**
     * Create request for operation 'publicAuthGet'
     *
     * @param  string $grant_type Method of authentication (required)
     * @param  string $username Required for grant type &#x60;password&#x60; (required)
     * @param  string $password Required for grant type &#x60;password&#x60; (required)
     ...
     */
    protected function publicAuthGetRequest($grant_type, $username, $password, $client_id, $client_secret, $refresh_token, $timestamp, $signature, $nonce = null, $state = null, $scope = null)
    {
        // verify the required parameter 'grant_type' is set
        if ($grant_type === null || (is_array($grant_type) && count($grant_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $grant_type when calling publicAuthGet'
            );
        }
        // verify the required parameter 'username' is set
        if ($username === null || (is_array($username) && count($username) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $username when calling publicAuthGet'
            );
        }
        // verify the required parameter 'password' is set
        if ($password === null || (is_array($password) && count($password) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $password when calling publicAuthGet'
            );
        }
        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_id when calling publicAuthGet'
            );
        }
        // verify the required parameter 'client_secret' is set
        if ($client_secret === null || (is_array($client_secret) && count($client_secret) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_secret when calling publicAuthGet'
            );
        }
        // verify the required parameter 'refresh_token' is set
        if ($refresh_token === null || (is_array($refresh_token) && count($refresh_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $refresh_token when calling publicAuthGet'
            );
        }
        // verify the required parameter 'timestamp' is set
        if ($timestamp === null || (is_array($timestamp) && count($timestamp) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $timestamp when calling publicAuthGet'
            );
        }
        // verify the required parameter 'signature' is set
        if ($signature === null || (is_array($signature) && count($signature) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $signature when calling publicAuthGet'
            );
        }

        $resourcePath = '/public/auth';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation publicDisableHeartbeatGet
     *
     ...
     * @return object|object
     */
    public function publicDisableHeartbeatGet()
    {
        list($response) = $this->publicDisableHeartbeatGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation publicDisableHeartbeatGetWithHttpInfo
     *
     * Stop sending heartbeat messages.
     *
     *
     ...
     * @return array of object|object, HTTP status code, HTTP response headers (array of strings)
     */
    public function publicDisableHeartbeatGetWithHttpInfo()
    {
        $request = $this->publicDisableHeartbeatGetRequest();
    ...
    /**
     * Operation publicDisableHeartbeatGetAsync
     *
     * Stop sending heartbeat messages.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicDisableHeartbeatGetAsync()
    {
        return $this->publicDisableHeartbeatGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation publicDisableHeartbeatGetAsyncWithHttpInfo
     *
     * Stop sending heartbeat messages.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicDisableHeartbeatGetAsyncWithHttpInfo()
    {
        $returnType = 'object';
        $request = $this->publicDisableHeartbeatGetRequest();
    ...
    /**
     * Create request for operation 'publicDisableHeartbeatGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function publicDisableHeartbeatGetRequest()
    {

        $resourcePath = '/public/disable_heartbeat';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation publicGetAnnouncementsGet
     *
     ...
     * @return object
     */
    public function publicGetAnnouncementsGet()
    {
        list($response) = $this->publicGetAnnouncementsGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation publicGetAnnouncementsGetWithHttpInfo
     *
     * Retrieves announcements from the last 30 days.
     *
     *
     ...
     */
    public function publicGetAnnouncementsGetWithHttpInfo()
    {
        $request = $this->publicGetAnnouncementsGetRequest();
    ...
    /**
     * Operation publicGetAnnouncementsGetAsync
     *
     * Retrieves announcements from the last 30 days.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicGetAnnouncementsGetAsync()
    {
        return $this->publicGetAnnouncementsGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation publicGetAnnouncementsGetAsyncWithHttpInfo
     *
     * Retrieves announcements from the last 30 days.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicGetAnnouncementsGetAsyncWithHttpInfo()
    {
        $returnType = 'object';
        $request = $this->publicGetAnnouncementsGetRequest();
    ...
    /**
     * Create request for operation 'publicGetAnnouncementsGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function publicGetAnnouncementsGetRequest()
    {

        $resourcePath = '/public/get_announcements';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return object
     */
    public function publicGetTimeGet()
    {
        list($response) = $this->publicGetTimeGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation publicGetTimeGetWithHttpInfo
     *
     * Retrieves the current time (in milliseconds). This API endpoint can be used to check the clock skew between your software and Deribit's systems.
     *
     *
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function publicGetTimeGetWithHttpInfo()
    {
        $request = $this->publicGetTimeGetRequest();
    ...
    /**
     * Operation publicGetTimeGetAsync
     *
     * Retrieves the current time (in milliseconds). This API endpoint can be used to check the clock skew between your software and Deribit's systems.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicGetTimeGetAsync()
    {
        return $this->publicGetTimeGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation publicGetTimeGetAsyncWithHttpInfo
     *
     * Retrieves the current time (in milliseconds). This API endpoint can be used to check the clock skew between your software and Deribit's systems.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicGetTimeGetAsyncWithHttpInfo()
    {
        $returnType = 'object';
        $request = $this->publicGetTimeGetRequest();
    ...
    /**
     * Create request for operation 'publicGetTimeGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function publicGetTimeGetRequest()
    {

        $resourcePath = '/public/get_time';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation publicHelloGet
     *
     * Method used to introduce the client software connected to Deribit platform over websocket. Provided data may have an impact on the maintained connection and will be collected for internal statistical purposes. In response, Deribit will also introduce itself.
     *
     * @param  string $client_name Client software name (required)
     * @param  string $client_version Client software version (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function publicHelloGet($client_name, $client_version)
    {
        list($response) = $this->publicHelloGetWithHttpInfo($client_name, $client_version);
        return $response;
    }

    /**
     * Operation publicHelloGetWithHttpInfo
     *
     * Method used to introduce the client software connected to Deribit platform over websocket. Provided data may have an impact on the maintained connection and will be collected for internal statistical purposes. In response, Deribit will also introduce itself.
     *
     * @param  string $client_name Client software name (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function publicHelloGetWithHttpInfo($client_name, $client_version)
    {
        $request = $this->publicHelloGetRequest($client_name, $client_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicHelloGetAsync($client_name, $client_version)
    {
        return $this->publicHelloGetAsyncWithHttpInfo($client_name, $client_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation publicHelloGetAsyncWithHttpInfo
     *
     * Method used to introduce the client software connected to Deribit platform over websocket. Provided data may have an impact on the maintained connection and will be collected for internal statistical purposes. In response, Deribit will also introduce itself.
     *
     * @param  string $client_name Client software name (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicHelloGetAsyncWithHttpInfo($client_name, $client_version)
    {
        $returnType = 'object';
        $request = $this->publicHelloGetRequest($client_name, $client_version);
    ...
    /**
     * Create request for operation 'publicHelloGet'
     *
     * @param  string $client_name Client software name (required)
     * @param  string $client_version Client software version (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function publicHelloGetRequest($client_name, $client_version)
    {
        // verify the required parameter 'client_name' is set
        if ($client_name === null || (is_array($client_name) && count($client_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_name when calling publicHelloGet'
            );
        }
        // verify the required parameter 'client_version' is set
        if ($client_version === null || (is_array($client_version) && count($client_version) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_version when calling publicHelloGet'
            );
        }

        $resourcePath = '/public/hello';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($client_version !== null) {
            $queryParams['client_version'] = ObjectSerializer::toQueryValue($client_version);
        }
    ...
    /**
     * Operation publicSetHeartbeatGet
     *
     ...
     * @return object
     */
    public function publicSetHeartbeatGet($interval)
    {
        list($response) = $this->publicSetHeartbeatGetWithHttpInfo($interval);
        return $response;
    }

    /**
     * Operation publicSetHeartbeatGetWithHttpInfo
     *
     * Signals the Websocket connection to send and request heartbeats. Heartbeats can be used to detect stale connections. When heartbeats have been set up, the API server will send `heartbeat` messages and `test_request` messages. Your software should respond to `test_request` messages by sending a `/api/v2/public/test` request. If your software fails to do so, the API server will immediately close the connection. If your account is configured to cancel on disconnect, any orders opened over the connection will be cancelled.
     *
     * @param  float $interval The heartbeat interval in seconds, but not less than 10 (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function publicSetHeartbeatGetWithHttpInfo($interval)
    {
        $request = $this->publicSetHeartbeatGetRequest($interval);
    ...
    /**
     * Operation publicSetHeartbeatGetAsync
     *
     * Signals the Websocket connection to send and request heartbeats. Heartbeats can be used to detect stale connections. When heartbeats have been set up, the API server will send `heartbeat` messages and `test_request` messages. Your software should respond to `test_request` messages by sending a `/api/v2/public/test` request. If your software fails to do so, the API server will immediately close the connection. If your account is configured to cancel on disconnect, any orders opened over the connection will be cancelled.
     *
     * @param  float $interval The heartbeat interval in seconds, but not less than 10 (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicSetHeartbeatGetAsync($interval)
    {
        return $this->publicSetHeartbeatGetAsyncWithHttpInfo($interval)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation publicSetHeartbeatGetAsyncWithHttpInfo
     *
     * Signals the Websocket connection to send and request heartbeats. Heartbeats can be used to detect stale connections. When heartbeats have been set up, the API server will send `heartbeat` messages and `test_request` messages. Your software should respond to `test_request` messages by sending a `/api/v2/public/test` request. If your software fails to do so, the API server will immediately close the connection. If your account is configured to cancel on disconnect, any orders opened over the connection will be cancelled.
     *
     * @param  float $interval The heartbeat interval in seconds, but not less than 10 (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicSetHeartbeatGetAsyncWithHttpInfo($interval)
    {
        $returnType = 'object';
        $request = $this->publicSetHeartbeatGetRequest($interval);
    ...
    /**
     * Create request for operation 'publicSetHeartbeatGet'
     *
     * @param  float $interval The heartbeat interval in seconds, but not less than 10 (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function publicSetHeartbeatGetRequest($interval)
    {
        // verify the required parameter 'interval' is set
        if ($interval === null || (is_array($interval) && count($interval) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $interval when calling publicSetHeartbeatGet'
            );
        }

        $resourcePath = '/public/set_heartbeat';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation publicSubscribeGet
     *
     * Subscribe to one or more channels.
     *
     * @param  string[] $channels A list of channels to subscribe to. (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|object
     */
    public function publicSubscribeGet($channels)
    {
        list($response) = $this->publicSubscribeGetWithHttpInfo($channels);
        return $response;
    }

    /**
     * Operation publicSubscribeGetWithHttpInfo
     *
     * Subscribe to one or more channels.
     *
     * @param  string[] $channels A list of channels to subscribe to. (required)
     ...
     * @return array of object|object, HTTP status code, HTTP response headers (array of strings)
     */
    public function publicSubscribeGetWithHttpInfo($channels)
    {
        $request = $this->publicSubscribeGetRequest($channels);
    ...
    /**
     * Operation publicSubscribeGetAsync
     *
     * Subscribe to one or more channels.
     *
     * @param  string[] $channels A list of channels to subscribe to. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicSubscribeGetAsync($channels)
    {
        return $this->publicSubscribeGetAsyncWithHttpInfo($channels)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation publicSubscribeGetAsyncWithHttpInfo
     *
     * Subscribe to one or more channels.
     *
     * @param  string[] $channels A list of channels to subscribe to. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicSubscribeGetAsyncWithHttpInfo($channels)
    {
        $returnType = 'object';
        $request = $this->publicSubscribeGetRequest($channels);
    ...
    /**
     * Create request for operation 'publicSubscribeGet'
     *
     * @param  string[] $channels A list of channels to subscribe to. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function publicSubscribeGetRequest($channels)
    {
        // verify the required parameter 'channels' is set
        if ($channels === null || (is_array($channels) && count($channels) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channels when calling publicSubscribeGet'
            );
        }

        $resourcePath = '/public/subscribe';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation publicTestGet
     *
     * Tests the connection to the API server, and returns its version. You can use this to make sure the API is reachable, and matches the expected version.
     *
     * @param  string $expected_result The value \&quot;exception\&quot; will trigger an error response. This may be useful for testing wrapper libraries. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function publicTestGet($expected_result = null)
    {
        list($response) = $this->publicTestGetWithHttpInfo($expected_result);
        return $response;
    }

    /**
     * Operation publicTestGetWithHttpInfo
     *
     * Tests the connection to the API server, and returns its version. You can use this to make sure the API is reachable, and matches the expected version.
     *
     * @param  string $expected_result The value \&quot;exception\&quot; will trigger an error response. This may be useful for testing wrapper libraries. (optional)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function publicTestGetWithHttpInfo($expected_result = null)
    {
        $request = $this->publicTestGetRequest($expected_result);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicTestGetAsync($expected_result = null)
    {
        return $this->publicTestGetAsyncWithHttpInfo($expected_result)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation publicTestGetAsyncWithHttpInfo
     *
     * Tests the connection to the API server, and returns its version. You can use this to make sure the API is reachable, and matches the expected version.
     *
     * @param  string $expected_result The value \&quot;exception\&quot; will trigger an error response. This may be useful for testing wrapper libraries. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publicTestGetAsyncWithHttpInfo($expected_result = null)
    {
        $returnType = 'object';
        $request = $this->publicTestGetRequest($expected_result);
    ...
    /**
     * Create request for operation 'publicTestGet'
     *
     * @param  string $expected_result The value \&quot;exception\&quot; will trigger an error response. This may be useful for testing wrapper libraries. (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function publicTestGetRequest($expected_result = null)
    {

        $resourcePath = '/public/test';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($expected_result !== null) {
            $queryParams['expected_result'] = ObjectSerializer::toQueryValue($expected_result);
        }
