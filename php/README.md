...
*WebsocketOnlyApi* | [**publicDisableHeartbeatGet**](docs/Api/WebsocketOnlyApi.md#publicdisableheartbeatget) | **GET** /public/disable_heartbeat | Stop sending heartbeat messages.
