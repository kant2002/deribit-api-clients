...
object InternalApi {
  ...
  def apply(baseUrl: String = "https://www.deribit.com/api/v2") = new InternalApi(baseUrl)
}

class InternalApi(baseUrl: String) {
   ...
   *   bearerAuth (http)
   */
  def publicGetFooterGet()(implicit basicAuth: BasicCredentials): ApiRequest[Any] =
    ApiRequest[Any](ApiMethods.GET, "https://www.deribit.com/api/v2", "/public/get_footer", "application/json")
      .withCredentials(basicAuth)
      .withSuccessResponse[Any](200)
   ...
   * @param currency The currency symbol
   */
  def publicGetOptionMarkPricesGet(currency: String)(implicit basicAuth: BasicCredentials): ApiRequest[Any] =
    ApiRequest[Any](ApiMethods.GET, "https://www.deribit.com/api/v2", "/public/get_option_mark_prices", "application/json")
      .withCredentials(basicAuth)
      .withQueryParam("currency", currency)
      .withSuccessResponse[Any](200)
