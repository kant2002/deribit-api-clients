...
object AccountManagementApi {

  def apply(baseUrl: String = "https://www.deribit.com/api/v2") = new AccountManagementApi(baseUrl)
}

class AccountManagementApi(baseUrl: String) {
