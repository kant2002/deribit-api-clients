...
object SubscriptionManagementApi {

  def apply(baseUrl: String = "https://www.deribit.com/api/v2") = new SubscriptionManagementApi(baseUrl)
}

class SubscriptionManagementApi(baseUrl: String) {
   ...
   * @param channels A list of channels to unsubscribe from.
   */
  def publicUnsubscribeGet(channels: Seq[String])(implicit basicAuth: BasicCredentials): ApiRequest[Any] =
    ApiRequest[Any](ApiMethods.GET, "https://www.deribit.com/api/v2", "/public/unsubscribe", "application/json")
      .withCredentials(basicAuth)
      .withQueryParam("channels", ArrayValues(channels, MULTI))
      .withSuccessResponse[Any](200)
      .withErrorResponse[Any](401)
