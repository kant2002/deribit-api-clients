...
case class Order (
  ...
  direction: OrderEnums.Direction,
  ...
  trigger: Option[OrderEnums.Trigger] = None,
...
object OrderEnums {
  ...
  type OrderState = OrderState.Value
  type Advanced = Advanced.Value
  type OrderType = OrderType.Value
  type OriginalOrderType = OriginalOrderType.Value
  ...
  object TimeInForce extends Enumeration {
    val GoodTilCancelled = Value("good_til_cancelled")
    val FillOrKill = Value("fill_or_kill")
    val ImmediateOrCancel = Value("immediate_or_cancel")
  }
  ...
  object OrderState extends Enumeration {
    ...
    val Untriggered = Value("untriggered")
    val Triggered = Value("triggered")
  }

  object Advanced extends Enumeration {
    val Usd = Value("usd")
    val Implv = Value("implv")
  }

  object OrderType extends Enumeration {
    val Market = Value("market")
    val Limit = Value("limit")
    val StopMarket = Value("stop_market")
    val StopLimit = Value("stop_limit")
  }

  object OriginalOrderType extends Enumeration {
    val Market = Value("market")
  }

  object Trigger extends Enumeration {
    val IndexPrice = Value("index_price")
    val MarkPrice = Value("mark_price")
    val LastPrice = Value("last_price")
  }
