...
case class UserTrade (
  /* Trade direction of the taker */
  direction: UserTradeEnums.Direction,
  /* Currency, i.e `\"BTC\"`, `\"ETH\"` */
  feeCurrency: UserTradeEnums.FeeCurrency,
  ...
  orderType: Option[UserTradeEnums.OrderType] = None,
  ...
  tickDirection: UserTradeEnums.TickDirection,
  ...
  liquidity: Option[UserTradeEnums.Liquidity] = None
) extends ApiModel

object UserTradeEnums {

  type Direction = Direction.Value
  type FeeCurrency = FeeCurrency.Value
  type OrderType = OrderType.Value
  type State = State.Value
  type TickDirection = TickDirection.Value
  type Liquidity = Liquidity.Value
  object Direction extends Enumeration {
    val Buy = Value("buy")
    val Sell = Value("sell")
  }

  object FeeCurrency extends Enumeration {
    val BTC = Value("BTC")
    val ETH = Value("ETH")
  }
  ...
  object OrderType extends Enumeration {
    ...
    val Liquidation = Value("liquidation")
  }
  ...
  object Liquidity extends Enumeration {
    val `M` = Value("M")
    val `T` = Value("T")
  }
