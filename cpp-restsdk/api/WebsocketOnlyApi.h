...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_WebsocketOnlyApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_WebsocketOnlyApi_H_
...
public:
    ...
    explicit WebsocketOnlyApi( std::shared_ptr<ApiClient> apiClient );

    virtual ~WebsocketOnlyApi();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_WebsocketOnlyApi_H_ */
