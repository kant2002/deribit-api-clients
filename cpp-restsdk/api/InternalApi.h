...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_InternalApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_InternalApi_H_
...
public:
    ...
    explicit InternalApi( std::shared_ptr<ApiClient> apiClient );
    ...
    /// 
    /// </remarks>
    pplx::task<std::shared_ptr<Object>> publicGetFooterGet(
    );
    /// <summary>
    ...
    /// </remarks>
    /// <param name="currency">The currency symbol</param>
    pplx::task<std::shared_ptr<Object>> publicGetOptionMarkPricesGet(
        utility::string_t currency
    );
    /// <summary>
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_InternalApi_H_ */
