...
pplx::task<void> AuthenticationApi::privateLogoutGet()
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("AuthenticationApi->privateLogoutGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("AuthenticationApi->privateLogoutGet does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<Object>> AuthenticationApi::publicAuthGet(utility::string_t grantType, utility::string_t username, utility::string_t password, utility::string_t clientId, utility::string_t clientSecret, utility::string_t refreshToken, utility::string_t timestamp, utility::string_t signature, boost::optional<utility::string_t> nonce, boost::optional<utility::string_t> state, boost::optional<utility::string_t> scope)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("AuthenticationApi->publicAuthGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("AuthenticationApi->publicAuthGet does not consume any supported media type"));
    }
