...
#ifndef ORG_OPENAPITOOLS_CLIENT_API_TradingApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_TradingApi_H_
...
public:
    ...
    explicit TradingApi( std::shared_ptr<ApiClient> apiClient );
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_TradingApi_H_ */
