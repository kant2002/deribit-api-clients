...
/*
 * SessionManagementApi.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_API_SessionManagementApi_H_
#define ORG_OPENAPITOOLS_CLIENT_API_SessionManagementApi_H_
...
public:
    ...
    explicit SessionManagementApi( std::shared_ptr<ApiClient> apiClient );

    virtual ~SessionManagementApi();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_API_SessionManagementApi_H_ */
