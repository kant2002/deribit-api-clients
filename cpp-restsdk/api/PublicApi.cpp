...
pplx::task<std::shared_ptr<Object>> PublicApi::publicDisableHeartbeatGet()
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("PublicApi->publicDisableHeartbeatGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("PublicApi->publicDisableHeartbeatGet does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<Object>> PublicApi::publicHelloGet(utility::string_t clientName, utility::string_t clientVersion)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("PublicApi->publicHelloGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("PublicApi->publicHelloGet does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<Object>> PublicApi::publicSetHeartbeatGet(double interval)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("PublicApi->publicSetHeartbeatGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("PublicApi->publicSetHeartbeatGet does not consume any supported media type"));
    }
...
pplx::task<std::shared_ptr<Object>> PublicApi::publicSubscribeGet(std::vector<utility::string_t> channels)
{
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("PublicApi->publicSubscribeGet does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("PublicApi->publicSubscribeGet does not consume any supported media type"));
    }
