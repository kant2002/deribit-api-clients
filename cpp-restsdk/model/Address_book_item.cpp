...
Address_book_item::Address_book_item()
{
...
void Address_book_item::validate()
{
    // TODO: implement validation
}

web::json::value Address_book_item::toJson() const
{
...
void Address_book_item::fromJson(const web::json::value& val)
{
...
void Address_book_item::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Address_book_item::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t Address_book_item::getCurrency() const
{
    return m_Currency;
}

void Address_book_item::setCurrency(const utility::string_t& value)
{
    m_Currency = value;
    
}

utility::string_t Address_book_item::getAddress() const
{
    return m_Address;
}

void Address_book_item::setAddress(const utility::string_t& value)
{
    m_Address = value;
    
}

utility::string_t Address_book_item::getType() const
{
    return m_Type;
}

void Address_book_item::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Address_book_item::typeIsSet() const
{
    return m_TypeIsSet;
}

void Address_book_item::unsetType()
{
    m_TypeIsSet = false;
}

int32_t Address_book_item::getCreationTimestamp() const
{
    return m_Creation_timestamp;
}

void Address_book_item::setCreationTimestamp(int32_t value)
{
