...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Instrument_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Instrument_H_
...
public:
    ...
    /// </summary>
    int32_t getContractSize() const;
    
    void setContractSize(int32_t value);
    ...
    /// </summary>
    utility::string_t getSettlementPeriod() const;
    
    void setSettlementPeriod(const utility::string_t& value);

    /// <summary>
    /// The strike value. (only for options)
    /// </summary>
    double getStrike() const;
    bool strikeIsSet() const;
    void unsetStrike();
    ...
    /// </summary>
    int32_t getExpirationTimestamp() const;
    
    void setExpirationTimestamp(int32_t value);
...
protected:
    utility::string_t m_Quote_currency;
        ...
        double m_Tick_size;
        int32_t m_Contract_size;
        bool m_Is_active;
        utility::string_t m_Option_type;
    bool m_Option_typeIsSet;
    double m_Min_trade_amount;
        utility::string_t m_Instrument_name;
        utility::string_t m_Settlement_period;
        double m_Strike;
    bool m_StrikeIsSet;
    utility::string_t m_Base_currency;
        int32_t m_Creation_timestamp;
        int32_t m_Expiration_timestamp;
    };
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Instrument_H_ */
