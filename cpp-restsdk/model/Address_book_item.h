...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Address_book_item_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Address_book_item_H_
...
/// 
/// </summary>
class  Address_book_item
    : public ModelBase
{
public:
    Address_book_item();
    virtual ~Address_book_item();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Address_book_item_H_ */
