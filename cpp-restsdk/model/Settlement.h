...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Settlement_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Settlement_H_
...
public:
    ...
    void setSessionProfitLoss(double value);
    ...
    void setFunding(double value);

    /// <summary>
    /// the amount of the socialized losses (in base currency; bankruptcy only)
    /// </summary>
    double getSocialized() const;
    bool socializedIsSet() const;
    void unsetSocialized();

    void setSocialized(double value);

    /// <summary>
    /// value of session bankrupcy (in base currency; bankruptcy only)
    /// </summary>
    double getSessionBankrupcy() const;
    bool sessionBankrupcyIsSet() const;
    void unsetSession_bankrupcy();

    void setSessionBankrupcy(double value);
    ...
    bool fundedIsSet() const;
    void unsetFunded();

    void setFunded(double value);
    ...
    bool sessionTaxIsSet() const;
    void unsetSession_tax();

    void setSessionTax(double value);

    /// <summary>
    /// rate of paid texes/fees (in base currency; bankruptcy only)
    /// </summary>
    double getSessionTaxRate() const;
    bool sessionTaxRateIsSet() const;
    void unsetSession_tax_rate();

    void setSessionTaxRate(double value);
...
protected:
    double m_Session_profit_loss;
        double m_Mark_price;
    bool m_Mark_priceIsSet;
    double m_Funding;
        double m_Socialized;
    bool m_SocializedIsSet;
    double m_Session_bankrupcy;
    bool m_Session_bankrupcyIsSet;
    int32_t m_Timestamp;
    ...
    double m_Index_price;
        double m_Session_tax;
    bool m_Session_taxIsSet;
    double m_Session_tax_rate;
    bool m_Session_tax_rateIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Settlement_H_ */
