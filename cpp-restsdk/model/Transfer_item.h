...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Transfer_item_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Transfer_item_H_
...
public:
    ...
    /// </summary>
    utility::string_t getOtherSide() const;
    
    void setOtherSide(const utility::string_t& value);
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Transfer_item_H_ */
