...
Order_id_initial_margin_pair::Order_id_initial_margin_pair()
{
...
void Order_id_initial_margin_pair::validate()
{
    // TODO: implement validation
}

web::json::value Order_id_initial_margin_pair::toJson() const
{
...
void Order_id_initial_margin_pair::fromJson(const web::json::value& val)
{
...
void Order_id_initial_margin_pair::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Order_id_initial_margin_pair::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t Order_id_initial_margin_pair::getOrderId() const
{
    return m_Order_id;
}

void Order_id_initial_margin_pair::setOrderId(const utility::string_t& value)
{
    m_Order_id = value;
    
}

double Order_id_initial_margin_pair::getInitialMargin() const
{
    return m_Initial_margin;
}

void Order_id_initial_margin_pair::setInitialMargin(double value)
{
