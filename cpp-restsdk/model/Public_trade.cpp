...
void Public_trade::validate()
{
    // TODO: implement validation
}

web::json::value Public_trade::toJson() const
{
...
void Public_trade::fromJson(const web::json::value& val)
{
...
void Public_trade::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Public_trade::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t Public_trade::getDirection() const
{
    return m_Direction;
}

void Public_trade::setDirection(const utility::string_t& value)
{
    m_Direction = value;
    
}

int32_t Public_trade::getTickDirection() const
{
    return m_Tick_direction;
}

void Public_trade::setTickDirection(int32_t value)
{
    m_Tick_direction = value;
    
}

int32_t Public_trade::getTimestamp() const
{
    return m_Timestamp;
}

void Public_trade::setTimestamp(int32_t value)
{
    m_Timestamp = value;
    
}

double Public_trade::getPrice() const
{
    return m_Price;
}

void Public_trade::setPrice(double value)
{
    m_Price = value;
    
}

int32_t Public_trade::getTradeSeq() const
{
    return m_Trade_seq;
}

void Public_trade::setTradeSeq(int32_t value)
{
    m_Trade_seq = value;
    
}

utility::string_t Public_trade::getTradeId() const
{
    return m_Trade_id;
}

void Public_trade::setTradeId(const utility::string_t& value)
{
    m_Trade_id = value;
    
}

double Public_trade::getIv() const
{
    return m_Iv;
}

void Public_trade::setIv(double value)
{
    m_Iv = value;
    m_IvIsSet = true;
}

bool Public_trade::ivIsSet() const
{
    return m_IvIsSet;
}

void Public_trade::unsetIv()
{
    m_IvIsSet = false;
}

double Public_trade::getIndexPrice() const
{
    return m_Index_price;
}

void Public_trade::setIndexPrice(double value)
{
    m_Index_price = value;
    
}

double Public_trade::getAmount() const
{
    return m_Amount;
}

void Public_trade::setAmount(double value)
{
    m_Amount = value;
    
}

utility::string_t Public_trade::getInstrumentName() const
{
    return m_Instrument_name;
}

void Public_trade::setInstrumentName(const utility::string_t& value)
{
