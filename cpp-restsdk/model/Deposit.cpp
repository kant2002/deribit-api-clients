...
web::json::value Deposit::toJson() const
{
    ...
    val[utility::conversions::to_string_t("received_timestamp")] = ModelBase::toJson(m_Received_timestamp);
...
void Deposit::fromJson(const web::json::value& val)
{
    ...
    setReceivedTimestamp(ModelBase::int32_tFromJson(val.at(utility::conversions::to_string_t("received_timestamp"))));
...
void Deposit::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("received_timestamp"), m_Received_timestamp));
...
void Deposit::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    setReceivedTimestamp(ModelBase::int32_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("received_timestamp"))));
...
int32_t Deposit::getUpdatedTimestamp() const
{
    return m_Updated_timestamp;
}

void Deposit::setUpdatedTimestamp(int32_t value)
{
...
void Deposit::setState(const utility::string_t& value)
{
    m_State = value;
    
}

int32_t Deposit::getReceivedTimestamp() const
{
    return m_Received_timestamp;
}

void Deposit::setReceivedTimestamp(int32_t value)
{
...
void Deposit::setCurrency(const utility::string_t& value)
{
    m_Currency = value;
    
}

utility::string_t Deposit::getAddress() const
{
    return m_Address;
}

void Deposit::setAddress(const utility::string_t& value)
{
    m_Address = value;
...
void Deposit::setAmount(double value)
{
    m_Amount = value;
    
}

utility::string_t Deposit::getTransactionId() const
{
    return m_Transaction_id;
}

void Deposit::setTransactionId(const utility::string_t& value)
{
