...
Transfer_item::Transfer_item()
{
    ...
    m_Amount = 0.0;
    m_Other_side = utility::conversions::to_string_t("");
...
void Transfer_item::validate()
{
    // TODO: implement validation
}

web::json::value Transfer_item::toJson() const
{
    ...
    val[utility::conversions::to_string_t("other_side")] = ModelBase::toJson(m_Other_side);
...
void Transfer_item::fromJson(const web::json::value& val)
{
    ...
    setOtherSide(ModelBase::stringFromJson(val.at(utility::conversions::to_string_t("other_side"))));
    ...
    setCreatedTimestamp(ModelBase::int32_tFromJson(val.at(utility::conversions::to_string_t("created_timestamp"))));
...
void Transfer_item::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("other_side"), m_Other_side));
...
void Transfer_item::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    setOtherSide(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("other_side"))));
...
int32_t Transfer_item::getUpdatedTimestamp() const
{
    return m_Updated_timestamp;
}

void Transfer_item::setUpdatedTimestamp(int32_t value)
{
    m_Updated_timestamp = value;
    
}

utility::string_t Transfer_item::getDirection() const
{
    return m_Direction;
}

void Transfer_item::setDirection(const utility::string_t& value)
{
    m_Direction = value;
    m_DirectionIsSet = true;
}

bool Transfer_item::directionIsSet() const
{
    return m_DirectionIsSet;
}

void Transfer_item::unsetDirection()
{
    m_DirectionIsSet = false;
}

double Transfer_item::getAmount() const
{
    return m_Amount;
}

void Transfer_item::setAmount(double value)
{
    m_Amount = value;
    
}

utility::string_t Transfer_item::getOtherSide() const
{
    return m_Other_side;
}

void Transfer_item::setOtherSide(const utility::string_t& value)
{
    m_Other_side = value;
    
}

utility::string_t Transfer_item::getCurrency() const
{
    return m_Currency;
}

void Transfer_item::setCurrency(const utility::string_t& value)
{
    m_Currency = value;
    
}

utility::string_t Transfer_item::getState() const
{
    return m_State;
}

void Transfer_item::setState(const utility::string_t& value)
{
    m_State = value;
    
}

int32_t Transfer_item::getCreatedTimestamp() const
{
    return m_Created_timestamp;
}

void Transfer_item::setCreatedTimestamp(int32_t value)
{
    m_Created_timestamp = value;
    
}

utility::string_t Transfer_item::getType() const
{
    return m_Type;
}

void Transfer_item::setType(const utility::string_t& value)
{
    m_Type = value;
    
}

int32_t Transfer_item::getId() const
{
    return m_Id;
}

void Transfer_item::setId(int32_t value)
{
    m_Id = value;
