...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Withdrawal_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Withdrawal_H_
...
public:
    ...
    /// </summary>
    int32_t getConfirmedTimestamp() const;
    bool confirmedTimestampIsSet() const;
    void unsetConfirmed_timestamp();

    void setConfirmedTimestamp(int32_t value);
...
protected:
    int32_t m_Updated_timestamp;
        double m_Fee;
    bool m_FeeIsSet;
    int32_t m_Confirmed_timestamp;
    bool m_Confirmed_timestampIsSet;
    double m_Amount;
        double m_Priority;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Withdrawal_H_ */
