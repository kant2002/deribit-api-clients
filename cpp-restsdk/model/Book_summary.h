...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Book_summary_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Book_summary_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// Book_summary members

    /// <summary>
    /// Name of the underlying future, or &#x60;&#39;index_price&#39;&#x60; (options only)
    /// </summary>
    utility::string_t getUnderlyingIndex() const;
    bool underlyingIndexIsSet() const;
    void unsetUnderlying_index();

    void setUnderlyingIndex(const utility::string_t& value);
    ...
    void setVolumeUsd(double value);
    ...
    void setQuoteCurrency(const utility::string_t& value);
    ...
    bool estimatedDeliveryPriceIsSet() const;
    void unsetEstimated_delivery_price();

    void setEstimatedDeliveryPrice(double value);
    ...
    bool funding8hIsSet() const;
    void unsetFunding_8h();

    void setFunding8h(double value);
    ...
    bool currentFundingIsSet() const;
    void unsetCurrent_funding();

    void setCurrentFunding(double value);


protected:
    utility::string_t m_Underlying_index;
    bool m_Underlying_indexIsSet;
    double m_Volume;
        double m_Volume_usd;
    ...
    double m_Bid_price;
        ...
        double m_High;
        double m_Estimated_delivery_price;
    bool m_Estimated_delivery_priceIsSet;
    double m_Last;
        double m_Mid_price;
        double m_Interest_rate;
    bool m_Interest_rateIsSet;
    double m_Funding_8h;
    bool m_Funding_8hIsSet;
    double m_Mark_price;
        double m_Ask_price;
    ...
    int32_t m_Creation_timestamp;
        double m_Current_funding;
    bool m_Current_fundingIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Book_summary_H_ */
