...
#' @title SubscriptionManagement operations
#' @description openapi.SubscriptionManagement
#'
...
#'
#'
#' PublicUnsubscribeGet Unsubscribe from one or more channels.
#'
#' }
#'
#' @importFrom caTools base64encode
#' @export
SubscriptionManagementApi <- R6::R6Class(
  ...
  public = list(
    ...
    PublicUnsubscribeGet = function(channels, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
