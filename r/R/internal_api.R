...
#'
#'
#' PublicGetFooterGet Get information to be displayed in the footer of the website.
#'
#'
#' PublicGetOptionMarkPricesGet Retrives market prices and its implied volatility of options instruments
#'
#'
...
InternalApi <- R6::R6Class(
  ...
  public = list(
    ...
    PublicGetFooterGet = function(...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()

      urlPath <- "/public/get_footer"
    ...
    PublicGetOptionMarkPricesGet = function(currency, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- c()
      ...
      urlPath <- "/public/get_option_mark_prices"
