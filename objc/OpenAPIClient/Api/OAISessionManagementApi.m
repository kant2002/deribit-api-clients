#import "OAISessionManagementApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAISessionManagementApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAISessionManagementApi

NSString* kOAISessionManagementApiErrorDomain = @"OAISessionManagementApiErrorDomain";
NSInteger kOAISessionManagementApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) publicSetHeartbeatGetWithInterval: (NSNumber*) interval
    ...
    if (interval == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAISessionManagementApiErrorDomain code:kOAISessionManagementApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
