#import "OAIAccountManagementApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAIAccountManagementApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIAccountManagementApi

NSString* kOAIAccountManagementApiErrorDomain = @"OAIAccountManagementApiErrorDomain";
NSInteger kOAIAccountManagementApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) privateChangeSubaccountNameGetWithSid: (NSNumber*) sid
    ...
    if (sid == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIAccountManagementApiErrorDomain code:kOAIAccountManagementApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
