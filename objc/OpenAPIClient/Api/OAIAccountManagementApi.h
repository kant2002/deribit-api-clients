...
@interface OAIAccountManagementApi: NSObject <OAIApi>

extern NSString* kOAIAccountManagementApiErrorDomain;
extern NSInteger kOAIAccountManagementApiMissingParamErrorCode;
