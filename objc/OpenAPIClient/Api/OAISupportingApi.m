#import "OAISupportingApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAISupportingApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAISupportingApi

NSString* kOAISupportingApiErrorDomain = @"OAISupportingApiErrorDomain";
NSInteger kOAISupportingApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) publicHelloGetWithClientName: (NSString*) clientName
    ...
    if (clientName == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAISupportingApiErrorDomain code:kOAISupportingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
