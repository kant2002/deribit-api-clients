#import "OAISubscriptionManagementApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"


@interface OAISubscriptionManagementApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAISubscriptionManagementApi

NSString* kOAISubscriptionManagementApiErrorDomain = @"OAISubscriptionManagementApiErrorDomain";
NSInteger kOAISubscriptionManagementApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) privateSubscribeGetWithChannels: (NSArray<NSString*>*) channels
    ...
    if (channels == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAISubscriptionManagementApiErrorDomain code:kOAISubscriptionManagementApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
