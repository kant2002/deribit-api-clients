...
@interface OAIWebsocketOnlyApi: NSObject <OAIApi>

extern NSString* kOAIWebsocketOnlyApiErrorDomain;
extern NSInteger kOAIWebsocketOnlyApiMissingParamErrorCode;
